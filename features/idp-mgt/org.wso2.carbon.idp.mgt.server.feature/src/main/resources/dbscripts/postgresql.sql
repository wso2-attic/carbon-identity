...
DROP TABLE IF EXISTS SP_IDP_RESIDENT;
DROP SEQUENCE IF EXISTS SP_IDP_RESIDENT_PK_SEQ;
CREATE SEQUENCE SP_IDP_RESIDENT_PK_SEQ;
CREATE TABLE SP_IDP_RESIDENT (
			SP_IDP_ID INTEGER DEFAULT NEXTVAL('SP_IDP_RESIDENT_PK_SEQ'),
