...
CREATE TABLE WF_BPS_PROFILE (
    ...
    HOST_URL LVARCHAR(45),
    USERNAME LVARCHAR(45),
    PASSWORD LVARCHAR(30),
    CALLBACK_HOST LVARCHAR (45),
    CALLBACK_USERNAME LVARCHAR (45),
    CALLBACK_PASSWORD LVARCHAR (30),
    TENANT_ID LVARCHAR (45),
...
CREATE TABLE WF_ENTITY_LOCK_STATE(
  ENTITY_ID LVARCHAR(500),
  ENTITY_TYPE VARCHAR(50),
  ATTRIBUTE_KEY VARCHAR(50),
  ATTRIBUTE_VALUE VARCHAR(50),
  PRIMARY KEY (ENTITY_ID,ENTITY_TYPE, ATTRIBUTE_KEY, ATTRIBUTE_VALUE)
);

CREATE TABLE WF_ENTITY_RELATIONSHIP_LOCK_STATE(
  ENTITY1_ID LVARCHAR(500),
  ENTITY1_TYPE VARCHAR(50),
  ENTITY2_ID LVARCHAR(500),
  ENTITY2_TYPE VARCHAR(50),
  ATTRIBUTE_KEY VARCHAR(50),
  ATTRIBUTE_VALUE VARCHAR(50),
  PRIMARY KEY (ENTITY1_ID,ENTITY1_TYPE,ENTITY2_ID,ENTITY2_TYPE, ATTRIBUTE_KEY, ATTRIBUTE_VALUE)
);
