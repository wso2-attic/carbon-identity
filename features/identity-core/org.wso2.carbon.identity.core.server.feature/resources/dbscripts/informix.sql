...
CREATE TABLE IF NOT EXISTS WF_WS_SERVICES (
    ...
    WS_ACTION LVARCHAR(255),
    SERVICE_ENDPOINT LVARCHAR(255),
    USERNAME LVARCHAR(30),
    PASSWORD LVARCHAR(30),
    PRIMARY KEY (ALIAS)
);
CREATE TABLE IF NOT EXISTS WF_EVENT_SUBSCRIPTIONS (
    SERVICE_ALIAS LVARCHAR(45),
    EVENT LVARCHAR(45),
    CONDITION LVARCHAR(2000),
    PRIORITY INTEGER DEFAULT 100,
    PRIMARY KEY (SERVICE_ALIAS, EVENT),
    FOREIGN KEY (SERVICE_ALIAS) REFERENCES WF_WS_SERVICES(ALIAS) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS WF_BPS_PROFILES (
    ALIAS LVARCHAR(45),
