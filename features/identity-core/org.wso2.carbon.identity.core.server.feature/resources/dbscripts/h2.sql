...
CREATE TABLE IF NOT EXISTS WF_WORKFLOWS(
    ...
    WORKFLOW_NAME VARCHAR (45),
    TEMPLATE_ID VARCHAR (45),
    IMPL_ID VARCHAR (45)
    PRIMARY KEY (WORKFLOW_ID)
);

CREATE TABLE IF NOT EXISTS WF_WORKFLOW_ASSOCIATIONS(
    EVENT_ID VARCHAR(45),
    CONDITION VARCHAR (2000),
    WORKFLOW_ID VARCHAR (45),
    FOREIGN KEY (EVENT_ID) REFERENCES WF_WORKFLOWS(WORKFLOW_ID)ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS WF_WORKFLOW_CONFIG_PARAMS(
    WORKFLOW_ID VARCHAR (45),
