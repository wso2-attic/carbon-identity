...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN_SCOPE_ASSOCIATION (
            ACCESS_TOKEN_SCOPE_ASSOCIATION_ID INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
            TOKEN_ID INT,
            TOKEN_SCOPE VARCHAR (60),
            PRIMARY KEY (ACCESS_TOKEN_SCOPE_ASSOCIATION_ID),
            FOREIGN KEY (TOKEN_ID) REFERENCES IDN_OAUTH2_ACCESS_TOKEN(TOKEN_ID) ON DELETE CASCADE,
            CONSTRAINT ACCESS_TOKEN_ASSOCIATION UNIQUE (TOKEN_ID,TOKEN_SCOPE)
);
