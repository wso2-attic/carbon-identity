...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[WF_ENTITY_LOCK_STATE]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[WF_ENTITY_RELATIONSHIP_LOCK_STATE]') AND TYPE IN (N'U'))
CREATE TABLE WF_ENTITY_RELATIONSHIP_LOCK_STATE(
  ENTITY1_ID VARCHAR(500),
  ENTITY1_TYPE VARCHAR(50),
  ENTITY2_ID VARCHAR(500),
