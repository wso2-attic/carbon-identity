...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN (
            ...
            FOREIGN KEY (CONSUMER_KEY) REFERENCES IDN_OAUTH_CONSUMER_APPS(CONSUMER_KEY) ON DELETE CASCADE,
            CONSTRAINT CON_APP_KEY UNIQUE (CONSUMER_KEY,AUTHZ_USER,USER_TYPE,TOKEN_SCOPE_HASH,TOKEN_STATE,
                                           TOKEN_STATE_ID)
);
...
DROP TABLE IF EXISTS WF_ENTITY_LOCK_STATE;
...
DROP TABLE IF EXISTS WF_ENTITY_RELATIONSHIP_LOCK_STATE;
