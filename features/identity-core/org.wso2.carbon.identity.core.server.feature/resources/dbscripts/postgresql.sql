...
DROP TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_SCOPE_ASSOCIATION;
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN_SCOPE_ASSOCIATION (
            TOKEN_ID VARCHAR (255),
...
CREATE TABLE SP_APP (
            ...
            IS_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID CHAR(1) DEFAULT '1',
            IS_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID CHAR(1) DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS IDN_USER_ACCOUNT_ASSOCIATION (
            ...
            DOMAIN_NAME VARCHAR(255) NOT NULL,
            USER_NAME VARCHAR(255) NOT NULL,
            PRIMARY KEY (DOMAIN_NAME, TENANT_ID, USER_NAME));
