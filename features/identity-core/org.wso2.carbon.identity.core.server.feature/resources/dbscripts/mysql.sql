...
CREATE TABLE IF NOT EXISTS FIDO_DEVICE_STORE (
	...
	TIME_REGISTERED TIMESTAMP,
      ...
      PRIMARY KEY (TENANT_ID, DOMAIN_NAME, USER_NAME, KEY_HANDLE))ENGINE INNODB;
...
CREATE TABLE IF NOT EXISTS WF_ENTITY_LOCK_STATE(
...
CREATE TABLE IF NOT EXISTS WF_ENTITY_RELATIONSHIP_LOCK_STATE(
