...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN (
			...
			PRIMARY KEY (ACCESS_TOKEN),
            FOREIGN KEY (CONSUMER_KEY) REFERENCES IDN_OAUTH_CONSUMER_APPS(CONSUMER_KEY) ON DELETE CASCADE,
            UNIQUE (CONSUMER_KEY, AUTHZ_USER,USER_TYPE,TOKEN_STATE,TOKEN_STATE_ID) CONSTRAINT CON_APP_KEY
);
...
CREATE TABLE IDN_OAUTH2_RESOURCE_SCOPE (
  RESOURCE LVARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_APPMGT_CLIENT (
            ID MEDIUMINT SERIAL UNIQUE,
            CLIENT_ID LVARCHAR (512) NOT NULL,
	    CLIENT_SECRETE LVARCHAR (512),
	    TENANT_ID MEDIUMINT NOT NULL,
            CLIENT_TYPE LVARCHAR (255) NOT NULL ,
