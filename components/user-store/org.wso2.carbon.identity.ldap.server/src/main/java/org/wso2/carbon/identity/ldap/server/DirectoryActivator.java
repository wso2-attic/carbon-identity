...
package org.wso2.carbon.identity.ldap.server;

import org.apache.log4j.Logger;
import org.osgi.framework.BundleActivator;
import org.osgi.framework.BundleContext;
import org.wso2.carbon.identity.apacheds.DirectoryServiceFactory;
import org.wso2.carbon.identity.apacheds.KDCServer;
import org.wso2.carbon.identity.apacheds.KdcConfiguration;
import org.wso2.carbon.identity.apacheds.LDAPConfiguration;
import org.wso2.carbon.identity.apacheds.LDAPServer;
import org.wso2.carbon.identity.apacheds.PartitionInfo;
import org.wso2.carbon.identity.apacheds.PartitionManager;
import org.wso2.carbon.identity.ldap.server.configuration.LDAPConfigurationBuilder;
import org.wso2.carbon.identity.ldap.server.exception.DirectoryServerException;
import org.wso2.carbon.identity.ldap.server.tenant.LDAPTenantManagerService;
...
public class DirectoryActivator implements BundleActivator {
    ...
    private void setWorkingDirectory(LDAPConfiguration ldapConfiguration)
        ...
        if (".".equals(ldapConfiguration.getWorkingDirectory())) {
            ...
            File bundleDataDir = new File(dataDir, "org.wso2.carbon.identity.directory");
