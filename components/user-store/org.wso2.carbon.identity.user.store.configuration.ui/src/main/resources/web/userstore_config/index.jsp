                ...
                <tr id=<%=Encode.forHtmlAttribute(domainId)%>>
                    ...
                    <td style="width: 45%;margin-top:10px;">
                        <a title="<fmt:message key='edit.userstore'/>"
                           onclick="edit('<%=Encode.forJavaScriptAttribute(domainId)%>','<%=Encode.forJavaScriptAttribute(className)%>');"
                        ...
                        <a title="<fmt:message key='disable.userstore'/>"
                           onclick="disable('<%=Encode.forJavaScriptAttribute(domainId)%>');return false;"
                        ...
                        <a title="<fmt:message key='enable.userstore'/>"
                           onclick="enable('<%=Encode.forJavaScriptAttribute(domainId)%>');return false;"
