...
public class EntitlementConstants {
    ...
    public static final class StatusTypes {
        ...
        private static final String[] ALL_TYPES = new String[]{ADD_POLICY, UPDATE_POLICY, GET_POLICY,
                                                               DELETE_POLICY, ENABLE_POLICY, PUBLISH_POLICY
                , ROLLBACK_POLICY};
    ...
    public static final class PolicyEditor {
        ...
        private static final String[] EDITOR_TYPES = new String[]{BASIC, STANDARD, RBAC, SET};
        private static final String[] BASIC_CATEGORIES = new String[]{BASIC_CATEGORY_SUBJECT,
                                                                      BASIC_CATEGORY_RESOURCE,
                                                                      BASIC_CATEGORY_ACTION, BASIC_CATEGORY_ENVIRONMENT};

        public static String[] getEditorTypes() {
            return EDITOR_TYPES.clone();
        }

        public static String[] getBasicCategories() {
            return BASIC_CATEGORIES.clone();
        }
    }
