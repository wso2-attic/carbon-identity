...
public class PolicyEditorEngine {
    ...
    private static  volatile ConcurrentHashMap<String, PolicyEditorEngine> policyEditorEngine =
            new ConcurrentHashMap<String, PolicyEditorEngine>();
    private static final Log log = LogFactory.getLog(PolicyEditorEngine.class);
