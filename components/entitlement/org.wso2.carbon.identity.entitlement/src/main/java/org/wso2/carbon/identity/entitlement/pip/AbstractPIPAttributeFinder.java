...
public abstract class AbstractPIPAttributeFinder implements PIPAttributeFinder {
    ...
    public Set<String> getAttributeValues(URI attributeType, URI attributeId, URI category,
                                          String issuer, EvaluationCtx evaluationCtx) throws EntitlementException {
        ...
        try {
            ...
            throw new EntitlementException("Error while trying get subject. ", e);
        }
        ...
        try {
            ...
            throw new EntitlementException("Error while trying get resource. ", e);
        }
        ...
        try {
            ...
            throw new EntitlementException("Error while trying get action. ", e);
        ...
        try {
            ...
            throw new EntitlementException("Error while trying get environment. ", e);
        ...
        if (attributeValues == null) {
            ...
            if (isAbstractAttributeCachingEnabled && key != null && attributeValues != null
