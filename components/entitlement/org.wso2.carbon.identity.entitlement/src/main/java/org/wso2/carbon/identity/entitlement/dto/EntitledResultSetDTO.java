 ...
 */
public class EntitledResultSetDTO implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EntitledResultSetDTO)) {
            return false;
        }

        EntitledResultSetDTO that = (EntitledResultSetDTO) o;

        if (advanceResult != that.advanceResult) {
            return false;
        }
        if (!Arrays.equals(entitledAttributesDTOs, that.entitledAttributesDTOs)) {
            return false;
        }
