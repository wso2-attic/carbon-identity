...
public class DecisionInvalidationCache extends EntitlementBaseCache<IdentityCacheKey, IdentityCacheEntry> {
    ...
    private static DecisionInvalidationCache decisionInvalidationCache = new DecisionInvalidationCache();
    private static final Log log = LogFactory.getLog(DecisionInvalidationCache.class);
