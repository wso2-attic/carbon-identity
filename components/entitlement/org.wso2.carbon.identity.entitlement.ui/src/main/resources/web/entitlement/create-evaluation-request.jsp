        ...
        <div id="workArea">
            <div class="goToAdvance">
                <a class='icon-link' href="../entitlement/eval-policy.jsp"
                   style='background-image:url(images/advanceview.png);float:none'><fmt:message
                        key="create.request.using.editor"/></a>
            </div>
            <form id="requestForm" name="requestForm" method="post" action="">
                <table class="styledLeft noBorders">
                    ...
                    %>
                    <tr>
                        <td colspan="3"><fmt:message key="eval.ent.policy.for.policyId"/> <b><%=policyId%>
                        </b></td>
                    </tr>
                    <%
                        }
                    ...
                    <tr>
                        <td>
                            <label><input type="checkbox" id="multipleRequest"
                                          ...
                                          <%if(multipleRequest != null){%>checked="checked" <%}%> >Multiple
                                                                                                   Request</label>
                        </td>
                        <td>
                            <label><input type="checkbox" id="returnPolicyList"
                                          name="returnPolicyList" value="true"
                                          <%if(returnPolicyList != null){%>checked="checked" <%}%> >Return Policy
                                                                                                    List</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 40%;margin-top:10px;">
                            <label><input type="checkbox" id="resourceNamesInclude"
                                          ...
                                          <%if(resourceNamesInclude != null){%>checked="checked" <%}%> >Include In
                                                                                                        Result</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 40%;margin-top:10px;">
                            ...
                            %>
                            <input type="text" name="environmentNames" id="environmentNames"
                        ...
                        <td style="width: 40%;margin-top:10px;">
                            <label><input type="checkbox" id="environmentNamesInclude"
                                          ...
                                          <%if(environmentNamesInclude != null){%>checked="checked" <%}%> >Include In
                                                                                                           Result</label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="buttonRow" colspan="3">
                            <%
                                if (policyId != null) {
                            %>
                            <input type="button" onclick="submitForm(false);" value="<fmt:message key="test.evaluate"/>"
                                   class="button"/>
                            <%
                            } else {
                            %>
                            <input type="button" onclick="submitForm(true);" value="<fmt:message key="pdp.evaluate"/>"
                                   class="button"/>
                            <%
                                }
                            %>
                            <input type="button" onclick="createRequest();" value="<fmt:message key="create.request"/>"
                                   class="button"/>
                            <input type="button" onclick="clearForm();" value="<fmt:message key="clear"/>"
                                   class="button"/>
