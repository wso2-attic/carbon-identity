...
<fmt:bundle basename="org.wso2.carbon.identity.entitlement.ui.i18n.Resources">
    ...
    <div id="middle">
        ...
        <div id="workArea">
            <form method="post" name="versionForm" id="versionForm"
                  action="show-policy-version.jsp?policyId=<%=policyId%>">
                ...
                <tr>
                    <td class="buttonRow">
                        <%
                            if (!EntitlementPolicyConstants.ENTITLEMENT_CURRENT_VERSION.equals(selectedVersion)) {
                        %>
                        <button class="button" onclick="submitForm(); return false;"><fmt:message
                                key="rollaback"/></button>
                        <%
                            }
                        %>
