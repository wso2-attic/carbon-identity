    ...
    <div id="middle">
        ...
        <div id="workArea">
                    ...
                    <td>
                        <div style="height:30px;">
                            <a href="#" class="icon-link" onclick="clearCache();return false;"
                               style="background-image:url(images/cleanCache.png);"><fmt:message
                                    key='ent.clear.cache'/></a>
                        </div>
                    </td>
                    <td>
                        <div style="height:30px;">
                            <a href="#" class="icon-link" onclick="clearAttributeCache();return false;"
                               style="background-image:url(images/cleanCache.png);"><fmt:message
                                    key='ent.clear.attribute.cache'/></a>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table class="styledLeft" style="width: 100%;margin-top:10px;">
                ...
                %>
                <tr>
                    <td class="leftCol-med"><%=policyFinder%>
                    </td>
                    <td>
            ...
            <table class="styledLeft" style="width: 100%;margin-top:10px;">
                ...
                %>
                <tr>
                    <td class="leftCol-med"><%=pipAttributeFinder%>
                    </td>
                    <td>
            ...
            <table class="styledLeft" style="width: 100%;margin-top:10px;">
                ...
                %>
                <tr>
                    <td class="leftCol-med"><%=pipResourceFinder%>
                    </td>
                    <td>
