                        ...
                        <td class="formRaw">
                            <table class="normal" cellpadding="0" cellspacing="0" class="treeTable" style="width:100%">
                                <tr>
                                    ...
                                    <td width="30%">
                                        <select id="selectedAttributeId" name="selectedAttributeId"
                                                class="text-box-big">
                                            <%
                                                for (String attributeId : attributeIds) {
                                                    if (selectedAttributeId != null && selectedAttributeId.equals(attributeId)) {
                                            %>
                                            <option value="<%=attributeId%>" selected="selected"><%=attributeId%>
                                            </option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%=attributeId%>"><%=attributeId%>
                                            </option>
                                            <%
                                                    }
                                                }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select type="hidden" id="selectedAttributeDataType"
                                                name="selectedAttributeDataType" class="text-box-big">
                                            <%
                                            ...
                                            %>
                                            <option value="<%=attributeDataType%>"
                                                    selected="selected"><%=attributeDataType%>
                                            </option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%=attributeDataType%>"><%=attributeDataType%>
                                            </option>
                                            <%
                                                    }
                                                }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select onchange="getFinderModule();" id="finderModule" name="finderModule"
                                            ...
                                            %>
                                            <option value="<%=moduleName%>" selected="selected"><%=moduleName%>
                                            </option>
                                            <%
                                            } else {
                                            %>
