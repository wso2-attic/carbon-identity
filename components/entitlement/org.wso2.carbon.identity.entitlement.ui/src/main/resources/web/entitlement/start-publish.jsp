    ...
    <div id="middle">
        ...
        <div id="workArea">
            <form action="start-publish.jsp" name="publishForm" method="post">
                        ...
                        <td style="width: 17%;margin-top:10px;">
                            <label>
                                <input id="updatePolicy" name="publishAction" type="radio" onchange="showOnChange()"
                                        <% if(EntitlementConstants.PolicyPublish.ACTION_UPDATE.equals(publishAction)){%>
                                       checked="checked" <% }%>
                        ...
                        <td style="width: 16%;margin-top:10px;">
                            <label>
                                <input id="orderPolicy" name="publishAction" type="radio" onchange="showOnChange()"
                                        <% if(EntitlementConstants.PolicyPublish.ACTION_ORDER.equals(publishAction)){%>
                                       checked="checked" <% }%>
                        ...
                        <td style="width: 16%;margin-top:10px;">
                            <label>
                                <input id="enablePolicy" name="publishAction" type="radio" onchange="showOnChange()"
                                        <% if(EntitlementConstants.PolicyPublish.ACTION_ENABLE.equals(publishAction)){%>
                                       checked="checked" <% }%>
                        ...
                        <td style="width: 16%;margin-top:10px;">
                            <label>
                                <input id="disablePolicy" name="publishAction" type="radio" onchange="showOnChange()"
                                        <% if(EntitlementConstants.PolicyPublish.ACTION_DISABLE.equals(publishAction)){%>
                                       checked="checked" <% }%>
                        ...
                        <td style="width: 16%;margin-top:10px;">
                            <label>
                                <input id="deletePolicy" name="publishAction" type="radio" onchange="showOnChange()"
                                        <% if(EntitlementConstants.PolicyPublish.ACTION_DELETE.equals(publishAction)){%>
                                       checked="checked" <% }%>
                ...
                <tr>
                    <td>
                        <input name="subscribersList" type="hidden"
                               value="<%=EntitlementConstants.PDP_SUBSCRIBER_ID%>"/>
                    </td>
                </tr>
                <%
                    }
