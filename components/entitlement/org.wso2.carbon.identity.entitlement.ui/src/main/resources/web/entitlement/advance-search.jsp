        ...
        <div id="workArea">
            <form id="requestForm" name="requestForm" method="post" action="advance-search.jsp">
                <table class="styledLeft noBorders">
                    ...
                    <tr>
                        <td class="leftCol-small"><fmt:message key='select.subject.type'/><span
                        ...
                        <td colspan="2">
                            <select onchange="getSelectedSubjectType();" id="subjectType" name="subjectType">
                                ...
                                %>
                                <option value="<%=subjectType%>" selected="selected"><%=subjectType%>
                                </option>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input <%if (enableChildSearch) {%> checked="checked" <%}%> type="checkbox"
                                                                name="enableChildSearch" value="true"/><fmt:message
                                key="enable.child.search"/>
                        </td>
                    </tr>
