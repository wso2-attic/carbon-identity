                    ...
                    <tr>
                        <td class="buttonRow">
                            <%
                                if (showResponse) {
                            %>
                            <input type="button" value="<fmt:message key='back.evaluate'/>" class="button"
                                   onclick="backToEvaluation();"/>
                            <%
                            } else {
                            %>
                            <%
                                if (policyId != null) {
                            %>
                            <input type="button" value="<fmt:message key='test.evaluate'/>" class="button"
                                   onclick="evaluateXACMLRequest(false);"/>
                            <%
                            } else {
                            %>
                            <input type="button" value="<fmt:message key='pdp.evaluate'/>" class="button"
                                   onclick="evaluateXACMLRequest(true);"/>
                            <%
                                }
                            %>
