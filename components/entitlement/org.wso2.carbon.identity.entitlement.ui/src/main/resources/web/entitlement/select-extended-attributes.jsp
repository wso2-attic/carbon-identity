                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="cAttributeIds" name="cAttributeIds" class="leftCol-small">
                                            ...
                                            %>
                                            <option value="<%=selectedAttributeId%>"
                                                    selected="selected"><%=selectedAttributeId%>
                                            </option>
                                            <%
                                                }
                                            %>
                                    ...
                                    <td>
                                        <select id="cDataType" name="cDataType" class="leftCol-small">
                                            ...
                                            %>
                                            <option value="<%=selectedDataType%>"
                                                    selected="selected"><%=selectedDataType%>
                                            </option>
                                            <%
                                                }
                                            %>
                                ...
                                <tr>
                                    <td>
                                        <table>
                                            ...
                                            %>
                                            <tr>
                                                <td><%=attributeDTO.getCategory()%>
                                                </td>
                                                <td><%=attributeDTO.getAttributeId()%>
                                                </td>
                                                <td><%=attributeDTO.getDataType()%>
                                                </td>
                                            </tr>
                                            <%
                                                    }
