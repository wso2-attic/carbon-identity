...
<script type="text/javascript">
    ...
    function createNewObligationRow() {
        ...
        jQuery('#obligationTable > tbody:last').append('<tr data-value="' + index + '">' +
                ...
                '<td style="padding-left:0px !important;padding-right:0px !important"><select id="obligationEffect_' + index + '" name="obligationEffect_' + index + '"><%if (ruleEffects != null) {for (String effect : ruleEffects) {if (effect.equals(currentObligationEffect)) {%><option value="<%=effect%>" selected="selected"><%=effect%></option><%} else {%><option value="<%=effect%>"><%=effect%></option><%}}}%></select></td>' +
        ...
        <div id="workArea">
            <form id="dataForm" name="dataForm" method="post" action="">
                <table id="mainTable" class="styledLeft noBorders">
                                        ...
                                        <td>
                                            <table id="multipleTargetTable" name="multipleTargetTable" class="normal"
                                                ...
                                                <tr data-value="0">
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="targetCombineFunctions_0"
                                                                name="targetCombineFunctions_0"
                                                                class="newTargetRow"
                                                                onchange="createNewTargetRow(this.options[this.selectedIndex].value)">
                                                            <%
                                    ...
                                    <tr>
                                        <td>
                                            <table class="normal" style="padding-left:0px !important">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <select id="ruleEffect" name="ruleEffect" class="leftCol-small">
                                                            ...
                                                            %>
                                                            <option value="<%=effect%>" selected="selected"><%=effect%>
                                                            </option>
                                                            <%
                                                            } else {
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <div class="sectionHelp"><fmt:message key="rule.target"/></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
                                                        <table id="multipleRuleTargetTable"
                                                               name="multipleRuleTargetTable" class="normal"
                                                               style="padding-left:0px !important">
                                                            <tr data-value="0">

                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="ruleTargetCategory_0"
                                                                            name="ruleTargetCategory_0">
                                                                        <%
                                                                            for (String category : categories) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="ruleTargetPreFunction_0"
                                                                            name="ruleTargetPreFunction_0">
                                                                        <%
                                                                            for (String targetPreFunction : targetPreFunctions) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="ruleTargetFunction_0"
                                                                            name="ruleTargetFunction_0"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            for (String targetFunction : targetFunctions) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    <input type="text" size="60"
                                                                           name="ruleTargetAttributeValue_0"
                                                                           id="ruleTargetAttributeValue_0"
                                                                           value="<%=currentRuleTargetAttributeValue%>"
                                                                           class="text-box-big"/>
                                                                    <%
                                                                    } else {
                                                                    %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="ruleTargetCombineFunctions_0"
                                                                            name="ruleTargetCombineFunctions_0"
                                                                            class="newRuleTargetRow"
                                                                            onchange="createNewRuleTargetRow(this.options[this.selectedIndex].value)">
                                                                        <%
                                                                            for (String combineFunction : combineFunctions) {
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="ruleTargetAttributeId_0"
                                                                           id="ruleTargetAttributeId_0"
                                                                           value="<%=currentRuleTargetAttributeId%>"/>
                                                                </td>

                                                                <td>
                                                                    <input type="hidden"
                                                                           name="ruleTargetAttributeTypes_0"
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <div class="sectionHelp"><fmt:message
                                                                key="rule.condition"/></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5">
                                                        <table id="multipleRuleTable" name="multipleRuleTable"
                                                               class="normal"
                                                               style="padding-left:0px !important">
                                                            <tr data-value="0">
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="rulePreFunction_0"
                                                                            name="rulePreFunction_0">
                                                                        <%
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    %>
                                                                    <input type="text" size="60"
                                                                           name="ruleAttributeValue_0"
                                                                           id="ruleAttributeValue_0"
                                                                           value="<%=currentRuleAttributeValue%>"
                                                                           class="text-box-big"/>
                                                                    <%
                                                                    } else {
                                                                    %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="ruleCombineFunctions_0"
                                                                            name="ruleCombineFunctions_0"
                                                                            class="newRuleRow"
                                                                            onchange="createNewRuleRow(this.options[this.selectedIndex].value)">
                                                                        <%
                                                                            for (String combineFunction : combineFunctions) {
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="ruleAttributeId_0"
                                                                           id="ruleAttributeId_0"
                                                                           value="<%=currentRuleAttributeId%>"/>
                                                                </td>
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                        <table id="obligationRuleTable" name="obligationRuleTable"
                                                               class="normal"
                                                               style="padding-left:0px !important">
                                                            <tr data-value="0">
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="obligationRuleType_0"
                                                                            name="obligationRuleType_0">
                                                                        <%
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    <input type="text" size="20"
                                                                           name="obligationRuleId_0"
                                                                           id="obligationRuleId_0"
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    <input type="text" size="40"
                                                                           name="obligationRuleAttributeValue_0"
                                                                           id="obligationRuleAttributeValue_0"
                                                                    ...
                                                                    <%--</td>--%>
                                                                <td>
                                                                    <a onclick="createNewRuleObligationRow();"
                                ...
                                <table id="obligationTable" name="obligationTable" class="normal"
                                    ...
                                    <tr data-value="0">
                                        ...
                                        <td style="padding-left:0px !important;padding-right:0px !important">
                                            ...
                                            %>
                                            <input type="text" size="40" name="obligationAttributeValue_0"
                                                   id="obligationAttributeValue_0"
                                                   value="<%=currentObligationAttributeValue%>"/>
                                            <%
                                            } else {
                                            %>
                                            ...
                                            <%--</td>--%>
                                        <td>
                                            <a onclick="createNewObligationRow();"
                                               style="background-image:url(images/add.gif);float:none" type="button"
                                               class="icon-link"></a>
                                        </td>
                                    </tr>
                                    <%
                    ...
                    <tr>
                        <td colspan="5">
                            <table id="dataTable" class="styledLeft"
                                   style="padding-left:0px !important;margin-top:20px;">
                                <thead>
                                <tr>
