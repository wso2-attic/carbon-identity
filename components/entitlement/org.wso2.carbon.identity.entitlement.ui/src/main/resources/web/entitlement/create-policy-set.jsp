                ...
                <table id="mainTable" class="styledLeft noBorders">
                    ...
                    <tr>
                        <td colspan="2" style="margin-top:10px;">
                            <h2 class="trigger  <%if(obligationDTOs == null || obligationDTOs.size() == 0){%>active<%} %>">
                                <a href="#"><fmt:message
                ...
                policySearchString.trim().length() == 0){%>active<%} %>"><a href="#"><fmt:message
                            ...
                            <div class="toggle_container" id="newPolicyRefLinkRow">
                                ...
                                <table style="width: 100%" id="policyTable" class="styledLeft">
                                    ...
                                    <tr>
                                        <td>
                                            <%=policies[i].getPolicyId()%>
                                        </td>
                                        <td width="50%">
                                            <a onclick="add('<%=policies[i].getPolicyId()%>', '<%=policies[i].getPolicyType()%>');return false;"
                                               href="#" style="background-image: url(images/add.gif);"
                                               class="icon-link">
                                ...
                                <carbon:paginator pageNumber="<%=pageNumberInt%>" numberOfPages="<%=numberOfPages%>"
                                                  action="post"
                                                  page="" pageNumberParameterName="pageNumber"
                        ...
                        <td colspan="5">
                            <table id="dataTable" style="width: 100%;margin-top:10px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="deletePolicyRef('<%=orderedRuleDTO.getId()%>')"
                                           class="icon-link"
