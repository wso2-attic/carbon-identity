    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <table class="styledLeft" style="width: 100%;margin-top:10px;">
                ...
                %>
                <tr>
                    <td><%=(new Date(Long.parseLong(dto.getTimeInstance()))).toString()%>
                    </td>
                    ...
                    <td><% if (dto.getSuccess()) {%> <fmt:message key="status.success"/> <%} else {%> <fmt:message
                            key="status.fail"/> <%} %></td>
        ...
        <div class="buttonRow">
            <a onclick="doCancel()" class="icon-link" style="background-image:none;">
                <fmt:message key="back.to.subscribersList"/></a>
