            ...
            <form id="dataForm" name="dataForm" method="post" action="">
                <table id="mainTable" class="styledLeft noBorders">
                    ...
                    <tr>
                        ...
                        %>
                        <td><textarea name="policyDescription" id="policyDescription" class="text-box-big"
                                      value="<%=policyDescription%>"></textarea></td>
                        <%
                        } else {
                        %>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="policyApplied"
                                    name="policyApplied" <%if (entitlementPolicyBean.isEditPolicy()) {%>
                                    disabled="disabled" <%}%>
                                ...
                                %>
                                <option value="<%=policyApply%>" selected="selected"><%=policyApply%>
                                </option>
                                <%
                                } else {
                                %>
                                <option value="<%=policyApply%>"><%=policyApply%>
                                </option>
                                <%
                                        }
                                    }
                        ...
                        <input type="hidden" name="policyApplied" id="policyApplied"
                               value="<%=selectedPolicyApplied%>"/>
                        <%}%>
                    </tr>
                        <%--</table> /////////////////// TODO--%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="userAttributeId" name="userAttributeId">
                                            ...
                                            %>
                                            <option value="<%=userAttribute%>" selected="selected"><%=userAttribute%>
                                            </option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%=userAttribute%>"><%=userAttribute%>
                                            </option>
                                            <%
                                                    }
                                                }
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="userAttributeValue" id="userAttributeValue"
                                               value="<%=selectedUserAttributeValue%>"/>
                                        <%
                                        } else {
                                        %>
                                        <input type="text" name="userAttributeValue" id="userAttributeValue"/>
                                        ...
                                        <table class="oneline-listing">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    %>
                                                    <input type="text" name="resourceRuleValue_0"
                                                           id="resourceRuleValue_0"
                                                           value="<%=selectedRuleResourceValue%>"/>
                                                    <%
                                                    } else {
                                                    %>
                                                    <input type="text" name="resourceRuleValue_0"
                                                ...
                                                <td>
                                                    <select id="environmentRuleId_0" name="environmentRuleId_0">
                                                        ...
                                                        %>
                                                        <option value="<%=userAttribute%>"
                                                                selected="selected"><%=selectedRuleEnvironmentId%>
                                                        </option>
                                                        <%
                                                        } else {
                                                        %>
                                                ...
                                                %>
                                                    <input type="text" name="environmentRuleValue_0"
                                                           id="environmentRuleValue_0"
                                                           value="<%=selectedRuleEnvironmentValue%>"/>
                                                    <%
                                                    } else {
                                                    %>
                                                    <input type="text" name="environmentRuleValue_0"
                                                ...
                                                <td>
                                                    <a onclick="createNewUserRuleRow();"
                        ...
                        <td colspan="2">
                            <table class="normal" style="padding-left:0px !important">
                                <tr>
                                    ...
                                    %>
                                    <td><input type="text" name="actionValue" id="actionValue"
                                               value="<%=selectedActionValue%>"/></td>
                                    <%
                                    } else {
                                    %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="userRuleAttributeId_0" name="userRuleAttributeId_0">
                                                        ...
                                                        %>
                                                        <option value="<%=userAttribute%>"
                                                                selected="selected"><%=userAttribute%>
                                                        </option>
                                                        <%
                                                        } else {
                                                        %>
                                                ...
                                                <td>
                                                    ...
                                                    %>
                                                    <input type="text" name="userRuleAttributeValue_0"
                                                           id="userRuleAttributeValue_0"
                                                           value="<%=selectedRuleUserAttributeValue%>"/>
                                                    <%
                                                    } else {
                                                    %>
                                                    <input type="text" name="userRuleAttributeValue_0"
                                                ...
                                                <td>
                                                    <a onclick="createNewActionRuleRow();"
                                                       style="background-image:url(images/add.gif);float:none"
                                                       type="button"
                                                       class="icon-link"></a>
                                                </td>
                        ...
                        <td colspan="2">
                            <table class="normal" style="padding-left:0px !important">
                                <tr>
                                    ...
                                    %>
                                    <td><input type="text" name="environmentValue" id="environmentValue"
                                               value="<%=selectedEnvironmentValue%>"/></td>
                                    <%
                                    } else {
                                    %>
                                    ...
                                    <td>
                                        <table class="oneline-listing">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="createNewEnvironmentRuleRow();"
                                                       style="background-image:url(images/add.gif);float:none"
                                                       type="button"
                                                       class="icon-link"></a>
                                                </td>
                        ...
                        <td colspan="2">
                            <table class="normal" style="padding-left:0px !important">
                                <tr>
                                    ...
                                    %>
                                    <td><input type="text" name="resourceValue" id="resourceValue"
                                               value="<%=selectedResourceValue%>"/></td>
                                    <%
                                    } else {
                                    %>
                                    ...
                                    <td>
                                        <table class="oneline-listing">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="createNewResourceRuleRow();"
                                                       style="background-image:url(images/add.gif);float:none"
                                                       type="button"
                                                       class="icon-link"></a>
                                                </td>
