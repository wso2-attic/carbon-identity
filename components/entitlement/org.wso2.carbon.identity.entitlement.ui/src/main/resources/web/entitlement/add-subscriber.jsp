            ...
            <form id="requestForm" name="requestForm" method="post" action="add-subscriber.jsp">
                ...
                <div class="sectionSub">
                    <table class="styledLeft" style="width: 100%;margin-top:10px;">
                        ...
                        %>
                        <tr>
                            <td><%=CharacterEncoder.getSafeText(dto.getDisplayName())%>
                            </td>
                            <td><%=CharacterEncoder.getSafeText(dto.getValue())%>
                            </td>
                        </tr>
                        <%
                                    }
                        ...
                        <td colspan="2">
                            <select onchange="getSelectedSubjectType();" id="selectedModule" name="selectedModule">
                                ...
                                <option value="<%=selectedModule%>"
                                        selected="selected"><%=CharacterEncoder.getSafeText(selectedModule)%>
                                </option>
                                <%
                                } else {
                                %>
                                <option value="<%=module.getModuleName()%>"><%=CharacterEncoder.getSafeText(module.getModuleName())%>
                                </option>
                                <%
                                            }
                                        }
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="<%=inputType%>" name="<%=dto.getId()%>" id="<%=dto.getId()%>"
                                   value="<%=dto.getValue()%>" <% if ("subscriberId".equals(dto.getId())) { %>
                                   readonly='readonly' <% } %> />
                            <%
                            } else {
                            %>
                    ...
                    <tr>
                        <td colspan="2" class="buttonRow">
                            <input class="button" type="button"
                                    <%if (subscriber != null) {%> value="<fmt:message key='update'/>"
                                   onclick="doUpdate();" <%} else { %>
