        ...
        <div id="workArea">
            ...
            <div class="sectionSub">
                ...
                <table class="styledLeft" style="width: 100%">
                    <tr>
                        <td>Name</td>
                        <td><%=policyFinderDataHolder.getModuleName()%>
                        </td>
                    </tr>
                    <tr>
                        <td>Class Name</td>
                        <td><%=policyFinderDataHolder.getClassName()%>
                        </td>
                    </tr>
                    <tr>
                        <td>Policy Ids</td>
                ...
                <table class="styledLeft" style="width: 100%">
                    <tr>
                        <td>Name</td>
                        <td><%=pipFinderDataHolder.getModuleName()%>
                        </td>
                    </tr>
                    <tr>
                        <td>Class Name</td>
                        <td><%=pipFinderDataHolder.getClassName()%>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="buttonRow">
                <a onclick="doCancel()" class="icon-link" style="background-image:none;">
                    <fmt:message key="back.to.pdp.config"/></a>
