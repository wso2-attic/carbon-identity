                ...
                <table style="width: 100%" id="dataTable" class="styledLeft">
                    ...
                    <tr>
                        <td style="width:100px;">
                            <a class="icon-link"
                               onclick="updownthis(this,'up',<%=request.getParameter("pageNumber")%>,<%=numberOfPages%>)"
                               style="background-image:url(../admin/images/up-arrow.gif)"></a>
                            <a class="icon-link"
                               onclick="updownthis(this,'down',<%=request.getParameter("pageNumber")%>,<%=numberOfPages%>)"
                        ...
                        <td>
                            <a <% if(edit) { %>href="policy-view.jsp?policyid=<%=policies[i].getPolicyId()%>" <% } %>><%=policies[i].getPolicyId()%>
                            </a>
                        </td>
                        ...
                        <td width="40%">
                            <a title="<fmt:message key='edit.policy'/>"
                               ...
                               href="#" style="background-image: url(images/edit.gif);" class="icon-link"> <fmt:message
                                    key='edit'/></a>
                        </td>
                    </tr>
                    <%
