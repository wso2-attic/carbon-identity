                ...
                <table id="mainTable" class="styledLeft noBorders">
                    ...
                    <tr>
                        ...
                        <td><textarea name="policyDescription" id="policyDescription"
                                      ...
                                      class="text-box-big"><%=entitlementPolicyBean.getPolicyDescription()%></textarea>
                        </td>
                        <%
                        } else {
                        %>
                                            ...
                                            <table class="normal" style="padding-left:0px !important">
                                                <tr>
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="functionOnResourcesTarget"
                                                                name="functionOnResourcesTarget" class="leftCol-small">
                                                            <%
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        ...
                                                        %>
                                                        <input type="text" size="60" name="resourceNamesTarget"
                                                               id="resourceNamesTarget"
                                                    ...
                                                    <td>
                                                        <a title="Select Resources Names" class='icon-link'
                                                           onclick='selectAttributes("Resource");'
                                                           style='background-image:url(images/registry.gif); float:right;'></a>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="resourceIdTarget"
                                                               id="resourceIdTarget" value="<%=resourceIdTarget%>"/>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="normal" style="padding-left:0px !important">
                                                <tr>
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="subjectIdTarget" name="subjectIdTarget"
                                                                class="leftCol-small">
                                                            <%
                                                                if (subjectIds != null) {
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="functionOnSubjectsTarget"
                                                                name="functionOnSubjectsTarget" class="leftCol-small">
                                                            <%
                                                                if (targetFunctionIds != null) {
                                                                    for (String functionId : targetFunctionIds) {
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <%
                                                            if (subjectNamesTarget != null && subjectNamesTarget.trim().length() > 0) {
                                                        %>
                                                        <input type="text" name="subjectNamesTarget"
                                                               id="subjectNamesTarget"
                                                               value="<%=subjectNamesTarget%>"
                                                               class="text-box-mid-big"/>
                                                        <%
                                                        } else {
                                                        %>
                                                        <input type="text" name="subjectNamesTarget"
                                                               id="subjectNamesTarget" class="text-box-mid-big"/>
                                                        <%
                                                            }
                                                        %>
                                                    </td>
                                                    <td>
                                                        <a title="Select Subject Names" class='icon-link'
                                                           onclick='selectAttributes("Subject");'
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="normal" style="padding-left:0px !important">
                                                <tr>
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="functionOnActionsTarget"
                                                                name="functionOnActionsTarget" class="leftCol-small">
                                                            <%
                                                                if (targetFunctionIds != null) {
                                                                    for (String functionId : targetFunctionIds) {
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        ...
                                                        %>
                                                        <input type="text" name="actionNamesTarget"
                                                               id="actionNamesTarget" value="<%=actionNamesTarget%>"
                                                               class="text-box-big"/>
                                                        <%
                                                        } else {
                                                        %>
                                                        <input type="text" name="actionNamesTarget"
                                                               id="actionNamesTarget" class="text-box-big"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="normal" style="padding-left:0px !important">
                                                <tr>
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="environmentIdTarget" name="environmentIdTarget"
                                                                class="leftCol-small">
                                                            <%
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        <select id="functionOnEnvironmentTarget"
                                                                name="functionOnEnvironmentTarget"
                                                                class="leftCol-small">
                                                            <%
                                                                if (targetFunctionIds != null) {
                                                                    for (String functionId : targetFunctionIds) {
                                                    ...
                                                    <td style="padding-left:0px !important;padding-right:0px !important">
                                                        ...
                                                        %>
                                                        <input type="text" name="environmentNamesTarget"
                                                               id="environmentNamesTarget"
                                                               value="<%=environmentNamesTarget%>"
                                                               class="text-box-mid-big"/>
                                                        <%
                                                        } else {
                                                        %>
                                                        <input type="text" name="environmentNamesTarget"
                                                               id="environmentNamesTarget" class="text-box-mid-big"/>
                                                    ...
                                                    <td>
                                                        <a title="Select Environment Names" class='icon-link'
                                                           onclick='selectAttributes("Environment");'
                                    ...
                                    <tr>
                                        <td>
                                            <table class="normal" cellspacing="0">
                                                ...
                                                %>
                                                <tr>
                                                    <td class="leftCol-vsmall" style="vertical-align:top !important">
                                                        <fmt:message key='policy.description'/></td>
                                                    <%
                                                        if (ruleDescription != null) {
                                                    %>
                                                    <td><input name="ruleDescription" id="ruleDescription"
                                                               value="<%=ruleDescription%>" class="text-box-big"/></td>
                                                    <%
                                                    } else {
                                                    %>
                                                    <td><input type="text" name="ruleDescription" id="ruleDescription"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table class="normal" style="padding-left:0px !important">
                                                            <tr>
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="preFunctionOnResources"
                                                                            name="preFunctionOnResources"
                                                                            class="leftCol-vsmall">
                                                                        <%
                                                                        ...
                                                                        %>
                                                                        <option value="<%=preFunctionId%>"
                                                                                selected="selected"><%=preFunctionId%>
                                                                        </option>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="functionOnResources"
                                                                            name="functionOnResources"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (functionIds != null) {
                                                                        ...
                                                                        %>
                                                                        <option value="<%=functionId%>"
                                                                                selected="selected"><%=functionOnResources%>
                                                                        </option>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    %>
                                                                    <input type="text" size="60" name="resourceNames"
                                                                           id="resourceNames"
                                                                           value="<%=resourceNames%>"
                                                                           class="text-box-big"/>
                                                                    <%
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="resourceId"
                                                                           id="resourceId" value="<%=resourceId%>"/>
                                                                </td>

                                                                <td>
                                                                    <input type="hidden" name="resourceDataType"
                                                                           id="resourceDataType"
                                                                           value="<%=resourceDataType%>"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <table class="normal" style="padding-left:0px !important">
                                                            <tr>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="preFunctionOnSubjects"
                                                                            name="preFunctionOnSubjects"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (preFunctionIds != null) {
                                                                                for (String preFunctionId : preFunctionIds) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="functionOnSubjects"
                                                                            name="functionOnSubjects"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (functionIds != null) {
                                                                                for (String functionId : functionIds) {
                                                                        ...
                                                                        %>
                                                                        <option value="<%=functionId%>"
                                                                                selected="selected"><%=functionOnSubjects%>
                                                                        </option>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    %>
                                                                    <input type="text" name="subjectNames"
                                                                           id="subjectNames"
                                                                           value="<%=subjectNames%>"
                                                                           class="text-box-mid-big"/>
                                                                    <%
                                                                    ...
                                                                    %>
                                                                    <input type="text" name="subjectNames"
                                                                           id="subjectNames" class="text-box-mid-big"/>
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="subjectDataType"
                                                                           id="subjectDataType"
                                                                           value="<%=subjectDataType%>"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <table class="normal" style="padding-left:0px !important">
                                                            <tr>
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="preFunctionOnActions"
                                                                            name="preFunctionOnActions"
                                                                            class="leftCol-vsmall">
                                                                        <%
                                                                            if (preFunctionIds != null) {
                                                                                for (String preFunctionId : preFunctionIds) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="functionOnActions"
                                                                            name="functionOnActions"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (functionIds != null) {
                                                                                for (String functionId : functionIds) {
                                                                        ...
                                                                        %>
                                                                        <option value="<%=functionId%>"
                                                                                selected="selected"><%=functionOnActions%>
                                                                        </option>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    %>
                                                                    <input type="text" name="actionNames"
                                                                           id="actionNames" value="<%=actionNames%>"
                                                                           class="text-box-big"/>
                                                                    <%
                                                                    } else {
                                                                    %>
                                                                    <input type="text" name="actionNames"
                                                                           id="actionNames" class="text-box-big"/>
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="actionDataType"
                                                                           id="actionDataType"
                                                                           value="<%=actionDataType%>"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <table class="normal" style="padding-left:0px !important">
                                                            <tr>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="preFunctionOnEnvironment"
                                                                            name="preFunctionOnEnvironment"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (preFunctionIds != null) {
                                                                                for (String preFunctionId : preFunctionIds) {
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    <select id="functionOnEnvironment"
                                                                            name="functionOnEnvironment"
                                                                            class="leftCol-small">
                                                                        <%
                                                                            if (functionIds != null) {
                                                                                for (String functionId : functionIds) {
                                                                        ...
                                                                        %>
                                                                        <option value="<%=functionId%>"
                                                                                selected="selected"><%=functionOnEnvironment%>
                                                                        </option>
                                                                        <%
                                                                        } else {
                                                                        %>
                                                                ...
                                                                <td style="padding-left:0px !important;padding-right:0px !important">
                                                                    ...
                                                                    %>
                                                                    <input type="text" name="environmentNames"
                                                                           id="environmentNames"
                                                                ...
                                                                <td>
                                                                    <a title="Select Environment Names"
                                                                       class='icon-link'
                                                                       onclick='selectAttributes("Environment");'
                                                                       style='background-image:url(images/calendar.jpg); float:right;'></a>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <input type="hidden" name="environmentDataType"
                                                                           id="environmentDataType"
                                                                           value="<%=environmentDataType%>"/>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                        ...
                        <td colspan="2">
                            <table id="dataTable" style="width: 100%;margin-top:10px;">
                                ...
                                <tr>
                                    ...
                                    <td><%=ruleElementDTO.getRuleEffect()%>
                                    </td>
                                    <td>
