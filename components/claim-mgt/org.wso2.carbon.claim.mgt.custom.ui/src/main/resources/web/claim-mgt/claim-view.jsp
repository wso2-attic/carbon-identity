...
<%@ page import="org.wso2.carbon.claim.custom.ui.client.ClaimAdminClient" %>
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <div style="height:30px;">
                <a href="javascript:document.location.href='add-claim.jsp?action=addClaim&dialect=<%=dialectUri%>'" class="icon-link"
            ...
            <div class="trigger-title-container">
                ...
                <a href="update-claim.jsp?action=updateClaim&dialect=<%=dialectUri%>&claimUri=<%=claims[j].getClaim().getClaimUri()%>"
