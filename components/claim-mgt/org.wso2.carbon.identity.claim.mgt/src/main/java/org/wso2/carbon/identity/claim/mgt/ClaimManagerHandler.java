...
import org.wso2.carbon.identity.claim.mgt.internal.ClaimManagementServiceComponent;
...
public enum ClaimManagerHandler {
    ...
    public Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> getMappingsFromCarbonDialectToOther(
            String otherDialectURI, Set<String> carbonClaimURIs, String tenantDomain)
            throws ClaimManagementException {

        Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> returnSet = new HashSet<>();

        if (UserCoreConstants.DEFAULT_CARBON_DIALECT.equals(otherDialectURI)) {
            for (String claimURI : carbonClaimURIs) {
                org.wso2.carbon.identity.claim.mgt.ClaimMapping claimMapping = new org.wso2.carbon.identity.claim.mgt.ClaimMapping(
                    ...
                    if (requestedClaimURI.equals(claimMapping.getClaim().getClaimUri())) {
                        ...
                        for (ClaimMapping carbonClaimMapping : claimMappingsInOtherDialect) {
                            if (mappedAttr.equals(carbonClaimMapping.getMappedAttribute())) {
                                returnSet.add(new org.wso2.carbon.identity.claim.mgt.ClaimMapping(
    ...
    public Map<String, String> getMappingsMapFromCarbonDialectToOther(String otherDialectURI,
        ...
        Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> mappings = getMappingsFromCarbonDialectToOther(
                otherDialectURI, carbonClaimURIs, tenantDomain);
        for (org.wso2.carbon.identity.claim.mgt.ClaimMapping mapping : mappings) {
     ...
     * @throws ClaimManagementException
     */
    public Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> getMappingsFromOtherDialectToCarbon(
            String otherDialectURI, Set<String> otherClaimURIs, String tenantDomain)
            throws ClaimManagementException {

        Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> returnSet = new HashSet<org.wso2.carbon.identity.claim.mgt.ClaimMapping>();
        ...
        if (otherDialectURI.equals(UserCoreConstants.DEFAULT_CARBON_DIALECT) && otherClaimURIs != null) {
        ...
        if (otherClaimURIs == null || otherClaimURIs.isEmpty()) {
            ...
            for (ClaimMapping claimMapping : allClaimMappingsInOtherDialect) {
                ...
                for (ClaimMapping carbonClaimMapping : allClaimMappingsInCarbonDialect) {
                    if (mappedAttr.equals(carbonClaimMapping.getMappedAttribute())) {
                        returnSet.add(new org.wso2.carbon.identity.claim.mgt.ClaimMapping(otherDialectURI,
    ...
    public Map<String, String> getMappingsMapFromOtherDialectToCarbon(String otherDialectURI,
        ...
        Map<String, String> returnMap = new HashMap<>();
        Set<org.wso2.carbon.identity.claim.mgt.ClaimMapping> mappings = getMappingsFromOtherDialectToCarbon(
