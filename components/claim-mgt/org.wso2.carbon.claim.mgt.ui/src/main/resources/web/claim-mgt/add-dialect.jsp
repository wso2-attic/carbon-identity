...
<%@page import="org.wso2.carbon.user.core.UserCoreConstants"%><fmt:bundle basename="org.wso2.carbon.claim.mgt.ui.i18n.Resources">
    ...
    <form name="adddialect" action="add-dialect-submit.jsp" method="post">
		...
		<tbody>
			...
			<td colspan="2" class="buttonRow">
	                      ...
	                      <input class="button" type="button" value="<fmt:message key='cancel'/>"  onclick="javascript:document.location.href='index.jsp?region=region1&item=claim_mgt_menu&ordinal=0'"/>
                  	</td>
			</tr>
