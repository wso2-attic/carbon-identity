...
<%@page import="org.wso2.carbon.identity.claim.mgt.stub.dto.ClaimAttributeDTO" %>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<%@ taglib uri="http://wso2.org/projects/carbon/taglibs/carbontags.jar"
           prefix="carbon" %>
<%@ page import="org.wso2.carbon.identity.claim.mgt.stub.dto.ClaimDTO" %>
...
<%
    ...
    try {
        ...
        forwardTo = "claim-view.jsp?store=" + store + "&dialect=" + dialect + "&ordinal=1";
    } catch (Exception e) {
        ...
        forwardTo = "add-claim.jsp?dialect=" + dialect + "&ordinal=2";
    }
%>
