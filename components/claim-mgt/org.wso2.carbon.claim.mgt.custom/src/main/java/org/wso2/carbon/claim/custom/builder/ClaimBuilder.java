...
package org.wso2.carbon.claim.custom.builder;
...
public class ClaimBuilder {
    ...
    public static Set<String> dialects = new HashSet<String>();
    int tenantId;
    ...
    public ClaimBuilder(Map<String, Map<String, String>> propertyHolder, int tenantId, DataSource dataSource) throws UserStoreException {
        this.tenantId = tenantId;
        claimMapping = new HashMap<>();
        populateProfileAndClaimMaps(propertyHolder,dataSource,tenantId);
    }
     ...
     */
    public void populateProfileAndClaimMaps(Map<String, Map<String, String>> propertyHolder,DataSource dataSource,int tenantId) throws UserStoreException {
