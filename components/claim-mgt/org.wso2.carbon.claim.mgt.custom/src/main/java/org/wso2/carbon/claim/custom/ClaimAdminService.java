...
import org.wso2.carbon.claim.custom.dto.ClaimAttributeDTO;
import org.wso2.carbon.claim.custom.dto.ClaimDTO;
import org.wso2.carbon.claim.custom.dto.ClaimDialectDTO;
import org.wso2.carbon.claim.custom.dto.ClaimMappingDTO;
...
public class ClaimAdminService {
     ...
     */
    public ClaimDialectDTO[] getClaimMappings() throws ClaimManagementException, UserStoreException {
        ...
        claimMappings = IdentityMgtClaimManager.getInstance().getAllClaimMappings();
     ...
     * @throws ClaimManagementException
     */
    public ClaimDialectDTO getClaimMappingByDialect(String dialectUri) throws ClaimManagementException, UserStoreException {
        ClaimMapping[] claimMappings;
        ClaimDialect claimDialect;

        claimMappings = IdentityMgtClaimManager.getInstance().getAllClaimMappings(dialectUri);
     ...
     * @throws ClaimManagementException
     */
    public void upateClaimMapping(ClaimMappingDTO claimMappingDTO) throws ClaimManagementException, UserStoreException, IdentityException {
        ...
        IdentityMgtClaimManager.getInstance().updateClaimMapping(claimMapping);
    }
     ...
     * @throws ClaimManagementException
     */
    public void addNewClaimMapping(ClaimMappingDTO claimMappingDTO) throws ClaimManagementException, UserStoreException, IdentityException {
        /*Convert the simple structure of ClaimMapping received, to the complex structure
        of ClaimMapping which is used in the back end. */
        ClaimMapping claimMapping = convertClaimMappingDTOToClaimMapping(claimMappingDTO);
        IdentityMgtClaimManager handler = IdentityMgtClaimManager.getInstance();
     ...
     * @throws ClaimManagementException
     */
    public void removeClaimMapping(String dialectUri, String claimUri) throws ClaimManagementException, UserStoreException, IdentityException {
        ...
        IdentityMgtClaimManager handler = IdentityMgtClaimManager.getInstance();
        handler.deleteClaimMapping(mapping);
    }
    ...
    public void addNewClaimDialect(ClaimDialectDTO claimDialectDTO) throws Exception {
        ...
        IdentityMgtClaimManager handler = IdentityMgtClaimManager.getInstance();
        handler.getInstance().addNewClaimDialect(claimDialect);
    }
