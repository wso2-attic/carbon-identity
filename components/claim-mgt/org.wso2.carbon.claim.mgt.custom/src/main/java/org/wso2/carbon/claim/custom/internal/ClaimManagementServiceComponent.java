...
package org.wso2.carbon.claim.custom.internal;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.osgi.framework.BundleContext;
import org.osgi.service.component.ComponentContext;
import org.wso2.carbon.claim.custom.ClaimManagerFactory;
...
public class ClaimManagementServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        try {
            ...
            ctxt.getBundleContext().registerService(org.wso2.carbon.user.core.claim.ClaimManagerFactory.class.getName(), new ClaimManagerFactory(),null);
            ClaimManagementServiceDataHolder.getInstance().setBundleContext(ctxt.getBundleContext());
        } catch (Throwable e) {
