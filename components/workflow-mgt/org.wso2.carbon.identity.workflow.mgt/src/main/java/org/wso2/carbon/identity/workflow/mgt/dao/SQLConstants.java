...
public class SQLConstants {
    ...
    public static final String GET_REQUESTS_OF_USER_FILTER_FROM_CREATED_TIME = "SELECT UUID, OPERATION_TYPE, " +
            "CREATED_AT, UPDATED_AT, STATUS, REQUEST FROM WF_REQUEST WHERE CREATED_BY = ? AND CREATED_AT > ? AND " +
            "CREATED_AT < ? LIMIT ?";

    public static final String GET_REQUESTS_OF_USER_FILTER_FROM_UPDATED_TIME = "SELECT UUID, OPERATION_TYPE, " +
            "CREATED_AT, UPDATED_AT, STATUS, REQUEST FROM WF_REQUEST WHERE CREATED_BY = ? AND UPDATED_AT > ? AND " +
            "UPDATED_AT < ? LIMIT ?";

    public static final String GET_REQUESTS_FILTER_FROM_CREATED_TIME = "SELECT UUID, OPERATION_TYPE, " +
            "CREATED_AT, UPDATED_AT, STATUS, REQUEST FROM WF_REQUEST WHERE CREATED_AT > ? AND CREATED_AT < ? LIMIT ?";

    public static final String GET_REQUESTS_FILTER_FROM_UPDATED_TIME = "SELECT UUID, OPERATION_TYPE, " +
            "CREATED_AT, UPDATED_AT, STATUS, REQUEST FROM WF_REQUEST WHERE UPDATED_AT > ? AND UPDATED_AT < ? LIMIT ?";

    public static final String ADD_WORKFLOW_REQUEST_RELATIONSHIP = "INSERT INTO WF_WORKFLOW_REQUEST_RELATIONSHIP " +
    ...
    public static final String GET_REQUEST_ID_OF_RELATIONSHIP = "SELECT REQUEST_ID FROM " +
            "WF_WORKFLOW_REQUEST_RELATIONSHIP WHERE RELATIONSHIP_ID = ?";

    public static final String GET_STATES_OF_REQUEST = "SELECT STATUS FROM " +
            "WF_WORKFLOW_REQUEST_RELATIONSHIP WHERE REQUEST_ID = ?";

    public static final String UPDATE_STATUS_OF_RELATIONSHIP = "UPDATE WF_WORKFLOW_REQUEST_RELATIONSHIP SET STATUS = " +
    ...
    public static final String GET_WORKFLOWS_OF_REQUEST = "SELECT WF_WORKFLOW.ID, WF_WORKFLOW.WF_NAME , " +
            "WF_WORKFLOW_REQUEST_RELATIONSHIP.STATUS, WF_WORKFLOW_REQUEST_RELATIONSHIP.UPDATED_AT FROM WF_WORKFLOW, " +
            "WF_WORKFLOW_REQUEST_RELATIONSHIP WHERE WF_WORKFLOW.ID = WF_WORKFLOW_REQUEST_RELATIONSHIP.WORKFLOW_ID AND" +
            " WF_WORKFLOW_REQUEST_RELATIONSHIP.REQUEST_ID = ?";
