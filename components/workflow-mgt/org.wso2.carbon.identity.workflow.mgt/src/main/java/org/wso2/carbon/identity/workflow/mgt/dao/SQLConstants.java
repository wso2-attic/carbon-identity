...
public class SQLConstants {
    ...
    public static final String ADD_WS_SERVICE_QUERY =
            "INSERT INTO WF_WS_SERVICES(ALIAS, DESCRIPTION, WS_ACTION, SERVICE_ENDPOINT, " +
                    "USERNAME, PASSWORD) VALUES (?, ?, ?, ?, ?, ?)";

    public static final String GET_WS_SERVICES_FOR_EVENT_QUERY = "SELECT WF_WS_SERVICES.ALIAS, WF_WS_SERVICES" +
            ".DESCRIPTION, WF_WS_SERVICES.WS_ACTION, WF_WS_SERVICES.SERVICE_ENDPOINT, WF_EVENT_SUBSCRIPTIONS" +
            ".PRIORITY, WF_WS_SERVICES.USERNAME, WF_WS_SERVICES.PASSWORD, WF_EVENT_SUBSCRIPTIONS.CONDITION FROM " +
            "WF_WS_SERVICES, WF_EVENT_SUBSCRIPTIONS WHERE WF_EVENT_SUBSCRIPTIONS.SERVICE_ALIAS = WF_WS_SERVICES.ALIAS" +
            " AND WF_EVENT_SUBSCRIPTIONS.EVENT = ?";

    public static final String DELETE_ASSOCIATION_QUERY = "DELETE FROM WF_EVENT_SUBSCRIPTIONS WHERE SERVICE_ALIAS = ?" +
            " AND EVENT = ?";
