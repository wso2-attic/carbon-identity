...
public class OAuthServerConfiguration {
    ...
    private void parseDefaultValidityPeriods(OMElement oauthConfigElem) {
        ...
        if (authzCodeTimeoutElem != null) {
            authorizationCodeValidityPeriodInSeconds = Integer.parseInt(authzCodeTimeoutElem.getText());
        }
        ...
        if (accessTokTimeoutElem != null) {
            userAccessTokenValidityPeriodInSeconds = Integer.parseInt(accessTokTimeoutElem.getText());
        }
        ...
        if (applicationAccessTokTimeoutElem != null) {
            applicationAccessTokenValidityPeriodInSeconds = Integer.parseInt(applicationAccessTokTimeoutElem.getText());
        }
        ...
        if (refreshTokenTimeoutElem != null) {
            refreshTokenValidityPeriodInSeconds = Integer.parseInt(refreshTokenTimeoutElem.getText().trim());
        }
        ...
        if (timeStampSkewElem != null) {
            timeStampSkewInSeconds = Integer.parseInt(timeStampSkewElem.getText());
        }
