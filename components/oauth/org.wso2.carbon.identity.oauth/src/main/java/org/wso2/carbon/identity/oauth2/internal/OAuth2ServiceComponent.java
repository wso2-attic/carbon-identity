...
public class OAuth2ServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        ServiceRegistration oauthApplicationMgtSR = bundleContext.registerService(
                ApplicationMgtListener.class.getName(), new OAuthApplicationMgtListener(), null);
        if (oauthApplicationMgtSR != null) {
            if (log.isDebugEnabled()) {
