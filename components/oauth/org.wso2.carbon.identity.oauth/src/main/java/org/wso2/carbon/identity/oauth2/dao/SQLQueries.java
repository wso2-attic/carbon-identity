...
public class SQLQueries {
    ...
    public static final String GET_ACCESS_TOKEN_BY_AUTHZUSER_AND_TENANTID_FOR_STATE = "SELECT DISTINCT ACCESS_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER=? AND TENANT_ID=? AND TOKEN_STATE=?";
