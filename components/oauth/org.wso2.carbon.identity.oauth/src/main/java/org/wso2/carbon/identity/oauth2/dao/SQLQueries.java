...
public class SQLQueries {
    public static final String STORE_AUTHORIZATION_CODE = "INSERT INTO  IDN_OAUTH2_AUTHORIZATION_CODE " +
            "(AUTHORIZATION_CODE, CONSUMER_KEY, CALLBACK_URL, SCOPE, AUTHZ_USER, USER_DOMAIN, TENANT_ID, " +
            "TIME_CREATED, VALIDITY_PERIOD) VALUES (?,?,?,?,?,?,?,?,?)";
    ...
    public static final String VALIDATE_AUTHZ_CODE = "SELECT AUTHZ_USER, USER_DOMAIN, TENANT_ID, SCOPE, " +
            ...
            "IDN_OAUTH2_AUTHORIZATION_CODE WHERE CONSUMER_KEY = ? AND AUTHORIZATION_CODE = ?";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE = "SELECT * FROM (SELECT " +
            ...
            "CONSUMER_KEY=? AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? ORDER BY " +
            "TIME_CREATED DESC) WHERE ROWNUM < 2 ";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MYSQL = "SELECT ACCESS_TOKEN, " +
            ...
            " TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? ORDER BY TIME_CREATED DESC LIMIT 1";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_USER = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            " IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY=? AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
            "TOKEN_STATE='ACTIVE') AS ACCESS_TOKEN_TABLE JOIN IDN_OAUTH2_SCOPE_ASSOCIATION ON ACCESS_TOKEN_TABLE" +
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_BY_CLIENT_ID_USER = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM" +
            " IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY=? AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
            "(TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) AS ACCESS_TOKEN_TABLE JOIN IDN_OAUTH2_SCOPE_ASSOCIATION" +
            " ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_SCOPE_ASSOCIATION.TOKEN_ID";

    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER, TENANT_ID, " +
            ...
            "TOKEN_ID, CONSUMER_KEY, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE ACCESS_TOKEN=? AND TOKEN_STATE='ACTIVE') AS ACCESS_TOKEN_TABLE JOIN IDN_OAUTH2_SCOPE_ASSOCIATION " +
            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_SCOPE_ASSOCIATION.TOKEN_ID";

    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER, TENANT_ID, " +
            "USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID FROM (SELECT " +
            "TOKEN_ID, CONSUMER_KEY, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE ACCESS_TOKEN=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) AS ACCESS_TOKEN_TABLE JOIN " +
    ...
    public static final String GET_DISTINCT_APPS_AUTHORIZED_BY_USER_ALL_TIME = "SELECT DISTINCT CONSUMER_KEY FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND (TOKEN_STATE='ACTIVE' " +
            "OR TOKEN_STATE='EXPIRED')";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_DB2SQL = "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            ...
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID FROM $accessTokenStoreTable WHERE CONSUMER_KEY = " +
            "? AND REFRESH_TOKEN = ? ORDER BY TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY) AS IDN_OAUTH2_ACCESS_TOKEN_SELECTED " +
            "JOIN IDN_OAUTH2_SCOPE_ASSOCIATION WHERE IDN_OAUTH2_ACCESS_TOKEN_SELECTED.TOKEN_ID =" +
            " IDN_OAUTH2_SCOPE_ASSOCIATION.TOKEN_ID";
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN = "INSERT INTO $accessTokenStoreTable (ACCESS_TOKEN, " +
            "REFRESH_TOKEN, CONSUMER_KEY, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
    ...
    public static final String LIST_ALL_TOKENS_IN_TENANT = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            " USER_DOMAIN, CONSUMER_KEY, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, " +
            "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM " +
            "IDN_OAUTH2_ACCESS_TOKEN WHERE TENANT_ID=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) AS " +
    ...
    public static final String LIST_ALL_TOKENS_IN_USER_STORE = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            "CONSUMER_KEY, TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN WHERE TENANT_ID=?" +
            " AND USER_DOMAIN=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) AS ACCESS_TOKEN_TABLE JOIN " +
            "IDN_OAUTH2_SCOPE_ASSOCIATION ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_SCOPE_ASSOCIATION.TOKEN_ID";

    public static final String LIST_LATEST_AUTHZ_CODES_IN_USER_DOMAIN = "SELECT AUTHORIZATION_CODE, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.SCOPE, TIME_CREATED, VALIDITY_PERIOD, CALLBACK_URL FROM (SELECT " +
            "AUTHZ_USER, CONSUMER_KEY, SCOPE, MAX(TIME_CREATED) AS TIMES FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE " +
            "TENANT_ID=? AND USER_DOMAIN=? group by (AUTHZ_USER, CONSUMER_KEY, SCOPE)) AS AUTHZ_SELECTED JOIN " +
            "IDN_OAUTH2_AUTHORIZATION_CODE WHERE AUTHZ_SELECTED.AUTHZ_USER=IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER " +
            "AND AUTHZ_SELECTED.CONSUMER_KEY=IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY AND AUTHZ_SELECTED" +
    ...
    public static final String LIST_LATEST_AUTHZ_CODES_IN_TENANT = "SELECT AUTHORIZATION_CODE, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY, IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.SCOPE, TIME_CREATED, VALIDITY_PERIOD, CALLBACK_URL, " +
            "IDN_OAUTH2_AUTHORIZATION_CODE.USER_DOMAIN FROM (SELECT AUTHZ_USER, USER_DOMAIN, CONSUMER_KEY, SCOPE, MAX" +
            "(TIME_CREATED) AS TIMES FROM IDN_OAUTH2_AUTHORIZATION_CODE WHERE TENANT_ID=? group by (AUTHZ_USER, " +
            "USER_DOMAIN, CONSUMER_KEY, SCOPE)) AS AUTHZ_SELECTED JOIN IDN_OAUTH2_AUTHORIZATION_CODE WHERE " +
            "AUTHZ_SELECTED.AUTHZ_USER=IDN_OAUTH2_AUTHORIZATION_CODE.AUTHZ_USER AND AUTHZ_SELECTED" +
            ".CONSUMER_KEY=IDN_OAUTH2_AUTHORIZATION_CODE.CONSUMER_KEY AND AUTHZ_SELECTED" +
            ...
            ".SCOPE=IDN_OAUTH2_AUTHORIZATION_CODE.SCOPE";
