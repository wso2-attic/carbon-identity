...
//            "VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_ORACLE =
            ...
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD,TOKEN_STATE, USER_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN WHERE" +
            " CONSUMER_KEY=? AND AUTHZ_USER=? AND TOKEN_SCOPE=? ORDER BY TIME_CREATED DESC)" +
                    " WHERE ROWNUM < 2 ";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_MSSQL =
            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD," +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN WHERE " +
                    "CONSUMER_KEY=? AND AUTHZ_USER=? AND TOKEN_SCOPE=? ORDER BY TIME_CREATED DESC";

    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_BY_CLIENT_ID_USER_SCOPE_POSTGRESQL =
            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED," +
                    " VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE FROM " +
                    "IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY=? AND AUTHZ_USER=? AND TOKEN_SCOPE=?" +
    ...
    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_BY_CLIENT_ID_USER =
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE FROM IDN_OAUTH2_ACCESS_TOKEN WHERE " +
            "CONSUMER_KEY=? AND AUTHZ_USER=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')";
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN = "SELECT CONSUMER_KEY, AUTHZ_USER, TOKEN_SCOPE," +
            ...
            "REFRESH_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN=? AND TOKEN_STATE='ACTIVE'";
