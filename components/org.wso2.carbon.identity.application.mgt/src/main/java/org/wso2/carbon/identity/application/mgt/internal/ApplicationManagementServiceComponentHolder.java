...
public class ApplicationManagementServiceComponentHolder {
	...
	/**
	 * Get axis Configuration context service
	 * 
	...
	/**
	 * Set axis Configuration context service
	 * 
	 * @param configContextService
	 */
	public static void setConfigContextService(ConfigurationContextService configContextService) {
