...
public class SAMLSSOServiceProviderInfoDTO implements Serializable {
    ...
    public SAMLSSOServiceProviderDTO[] getServiceProviders() {
        ...
        if (serviceProviders == null) {
            return new SAMLSSOServiceProviderDTO[0];
        }
        return serviceProviders.clone();
    }

    public void setServiceProviders(SAMLSSOServiceProviderDTO[] serviceProviders) {

        if (serviceProviders == null) {
            serviceProviders = new SAMLSSOServiceProviderDTO[0];
        }
        this.serviceProviders = serviceProviders.clone();
    }
