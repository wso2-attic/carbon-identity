...
public interface DoSignResponse extends SAMLObject {

    /**
     * Element name, no namespace
     */
    String DEFAULT_ELEMENT_LOCAL_NAME = "DoSignResponse";
     ...
     */
    String TYPE_LOCAL_NAME = "DoSignResponseType";
    ...
    boolean getDoSignResponse();

    void setDoSignResponse(boolean doSignResponse);
}
