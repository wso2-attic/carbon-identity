...
package org.wso2.carbon.identity.saml.metadata.extensions.audience;
...
public class AudienceBuilder extends AbstractSAMLObjectBuilder<Audience> {
    ...
    public Audience buildObject() {
        return buildObject(SAMLConstants.SAML20MD_NS, Audience.DEFAULT_ELEMENT_LOCAL_NAME, SAMLConstants
                .SAML20MD_PREFIX);
    }
