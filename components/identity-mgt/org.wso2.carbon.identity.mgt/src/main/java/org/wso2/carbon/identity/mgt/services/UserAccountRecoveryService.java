...
public class UserAccountRecoveryService {
    ...
    Log log = LogFactory.getLog(UserAccountRecoveryService.class);
     ...
     * @throws IdentityMgtServiceException
     */
    public void recoverUserIdentityWithNotification(String userName) throws IdentityMgtServiceException {
        UserRecoveryDTO dto = new UserRecoveryDTO(userName);
        dto.setNotification(IdentityMgtConstants.Notification.TEMPORARY_PASSWORD);
