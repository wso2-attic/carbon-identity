...
/**
 * @scr.component name="carbon.notification.json" immediate="true"
 */
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("JSON message sender on user operation component is activated ");
            }
        } catch (Throwable t) {
            log.error("Error while initializing  JSON  message sending module",t);
        }
    }

    protected void deactivate(ComponentContext ctxt) {
        if (log.isDebugEnabled()) {
            log.debug("JSON message sending module is deactivated");
        }
    }
}