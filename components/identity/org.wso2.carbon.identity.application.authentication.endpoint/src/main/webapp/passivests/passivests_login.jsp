...
<fmt:bundle basename="org.wso2.carbon.identity.application.authentication.endpoint.i18n.passivests.Resources">
 <%
	...
	if (request.getParameter("authFailure") != null &&
		"true".equals(request.getParameter("authFailure"))) {
		loginFailed = true;
...
<html lang="en">
    <head>
        ...
        <!-- Le styles -->
        <link href="/authenticationendpoint/passivests/assets/css/bootstrap.min.css" rel="stylesheet">
        <link href="/authenticationendpoint/passivests/css/localstyles.css" rel="stylesheet">
        <!--[if lt IE 8]>
        ...
        <![endif]-->
        <script src="/authenticationendpoint/passivests/assets/js/jquery-1.7.1.min.js"></script>
        <script src="/authenticationendpoint/passivests/js/scripts.js"></script>
            ...
            <div class="span6 offset3 content-section" style="margin-left:230px">
				...
				<div id="loginTable1" class="identity-box">
				   ...
				   if (loginType.equals("basicauth") ) {%>
					...
					Login with : 
						<a href="/authenticationendpoint/passivests/passivests_login.jsp?loginType=basicauth&<%=queryString%>">Username/Password</a> &nbsp; | &nbsp;
						<a href="/authenticationendpoint/passivests/passivests_login.jsp?loginType=openid&<%=queryString%>">OpenID</a> &nbsp; | &nbsp;
