...
public class NotificationManagementServiceComponent {
    ...
    private List<NotificationSendingModule> notificationSendingModules = new
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Message management bundle is activated");
            }
            // Catch throwable since there may be run time exceptions.
        } catch (Throwable t) {
            log.error("Error while initiating MessageSendingModule", t);
        }
    }

    protected void deactivate(ComponentContext context) {
        if (log.isDebugEnabled()) {
            log.debug("Message management bundle is deactivated");
        }
    }
     ...
     */
    protected void addMessageSendingModule(NotificationSendingModule module) throws
     ...
     * a module is dynamically stops, this method will unregister them.
     *
     * @param module MessageSendingModule
     */
    protected void removeMessageSendingModule(NotificationSendingModule module) {
        if (log.isDebugEnabled()) {
