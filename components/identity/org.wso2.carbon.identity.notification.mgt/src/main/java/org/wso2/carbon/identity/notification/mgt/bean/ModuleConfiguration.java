...
/**
 * Configuration bean which is passed to Notification sending modules by the notification
 * management component. This includes all configuration information which are specific to a
 * certain notification sending component.
 */
