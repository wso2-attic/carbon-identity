...
/**
 * A base class for all cache implementations in Application Authentication Framework module.
 */
public class BaseCache <K extends Serializable, V extends Serializable> {
	
    private static final String APP_AUTH_FRAMEWORK_CACHE_MANAGER = "AppAuthFrameworkCacheManager";
	...
	private Cache<K,V> getBaseCache() {
        ...
        CacheManager cacheManager = Caching.getCacheManagerFactory().getCacheManager(APP_AUTH_FRAMEWORK_CACHE_MANAGER);
