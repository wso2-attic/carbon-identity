...
<fmt:bundle
	...
	<script type="text/javascript">
		...
		function removeItem(issuer) {
	        CARBON.showConfirmationDialog(
	                '<fmt:message key="application.info.saml2sso.alert.delete.about"/>' + " " + issuer
	                        + '<fmt:message key="application.info.saml2sso.alert.delete.proceed"/>',
	                function () {
        ...
        function itemRemoveOAuth(consumerkey) {
            CARBON.showConfirmationDialog("<fmt:message key='application.info.oauthoidc.alert.delete.proceed'/>" + consumerkey + "<fmt:message key='application.info.oauthoidc.alert.delete.proceed'/>",
                                          function () {
	...
	<div id="middle">
		...
		<h2>
			<fmt:message key='application.update.application' />
		</h2>
			...
			<table style="width: 100%" class="styledLeft">
				<tbody>
					<tr>
						...
						try {
							...
							trustedIDPs = serviceClient.getIDPList();
								...
								String message = resourceBundle.getString("error.while.reading.idp.info") + " : " + e.getMessage();
						...
						<table class="styledLeft noBorders">
							...
							<form method="POST" action="add-idp.jsp" id="add_idp_form">
								<tr>
									...
									<td>
										<input type="submit" name="application_identifier" style="padding-right: 0 !important;" id="application_identifier" value="Add To Trust" onclick="onClickAddIDP();"/>
									</td>
								</tr>
								</form>
							</tbody>
					...
					<tr>
						...
						<input name="update" type="button" class="button" value="<fmt:message key='application.update.createapp'/>" onclick="createAppOnclick();" /> 
						<input type="button" class="button" onclick="javascript:location.href='add-app.jsp'" value="<fmt:message key='application.create.cancel'/>" /></td>
					</tr>
				</tbody>
			</table>
		</div>
