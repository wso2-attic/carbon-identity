...
<fmt:bundle
	...
	<%
			...
			String appid = (String) request.getParameter("appid_hidden");
			...
			if(appid != null && !"".equals(appid)) {
				try {
					...
					appBean.addTrustedIDPConfig(serviceClient.getIDPData(idp));
				...
				String message = resourceBundle.getString("alert.please.provide.service.provider.id");
