	...
	<%
		...
		if (spName != null && !"".equals(spName)) {
			...
			try {
				...
				FederatedIdentityProvider[] federatedIdPs = serviceClient.getAllFederatedIdentityProvider();
				String[] claimUris = serviceClient.getAllClaimUris();
				LocalAuthenticator[] localAuthenticators = serviceClient.getAllLocalAuthenticators();
				RequestPathAuthenticator[] requestPathAuthenticators = serviceClient.getAllRequestPathAuthenticators();
				appBean.setServiceProvider(serviceProvider);
				appBean.setLocalAuthenticators(localAuthenticators);
