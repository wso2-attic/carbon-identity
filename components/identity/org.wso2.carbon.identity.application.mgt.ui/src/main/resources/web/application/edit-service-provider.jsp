	    ...
	    ResourceBundle resourceBundle = ResourceBundle.getBundle(BUNDLE, request.getLocale());
			...
			if (appid != null && !"".equals(appid)) {
				...
				try {
					...
					ApplicationConfigBean dataBean = serviceClient.getApplicationData(appid);
					appBean.setOauthoidcConfig(dataBean.getOauthoidcConfig());
					appBean.setSamlssoConfig(dataBean.getSamlssoConfig());
					appBean.setTrustedIdpConfig(dataBean.getTrustedIdpConfig());
					appBean.setUpdating(true);
