...
public class DeviceStoreDAO {
	...
	public void addDeviceRegistration(String username, DeviceRegistration registration) throws IdentityException {
		LOG.trace("Executing {addDeviceRegistration} method");
		...
		LOG.trace("Completed {addDeviceRegistration} method");
	}

	public Collection getDeviceRegistration(String username) throws IdentityException {
		LOG.trace("Executing {getDeviceRegistration} method");
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		...
		if (LOG.isTraceEnabled()) {
			LOG.trace("Completed {getDeviceRegistration} method, returns devices of size :" + devices.size());
		}
