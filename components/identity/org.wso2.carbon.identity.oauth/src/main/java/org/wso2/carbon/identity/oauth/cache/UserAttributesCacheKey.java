...
public class UserAttributesCacheKey extends CacheKey {
    ...
    public UserAttributesCacheKey(String userAttributesId) {
    ...
    public boolean equals(Object o) {
        if(!(o instanceof UserAttributesCacheKey)){
            return false;
        }
        return this.userAttributesId.equals(((UserAttributesCacheKey)o).getUserAttributesId());
    }
