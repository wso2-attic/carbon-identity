...
<%
    ...
    if (xmlToken != null) {
        ...
        try {
            ...
            openIdDto.setUserName(signin.getUserID());
            openIdDto.setOpenID(openID.getOpenID());
            boolean status = client.addOpenIDToProfile(openIdDto);
            ...
            if (status) {
                ...
                if (forwardPage != null) {
                    forwardTo = "openid_sign_in.jsp?forwardPage=" +
