...
public class SalesforceSCIMProvisioningConnectorResponseHandler implements ClientHandler {
    ...
    public ClientResponse handle(ClientRequest clientRequest, HandlerContext handlerContext)
    	...
    	System.out.println(clientRequest.getHeaders().toString());
        ...
        if (scimClient != null) {
        	...
        	System.out.println(cr.getStatusCode());
