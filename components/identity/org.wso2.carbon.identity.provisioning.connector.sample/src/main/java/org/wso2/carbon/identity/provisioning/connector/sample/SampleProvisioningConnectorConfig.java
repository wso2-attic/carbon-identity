...
public class SampleProvisioningConnectorConfig implements Serializable {

    private static final long serialVersionUID = 1466757093641438420L;
    
    private static final Log log = LogFactory.getLog(SampleProvisioningConnectorConfig.class);
    ...
    public static final String IDENTITY_PROVISIONING_CONNECTOR = "Identity.Provisioning.Connector.Windows.Domain.Name";

    /**
     * 
     * @param configs
     */
    public SampleProvisioningConnectorConfig(Properties configs) {
    ...
    public List<String> getRequiredAttributeNames() {
        ...
        String requiredAttributes = this.configs
                .getProperty(SampleConnectorConstants.PropertyConfig.REQUIRED_FIELDS);
    ...
    public String getUserIdClaim() throws IdentityProvisioningException {
        String userIDClaim = this.configs
                .getProperty(SampleConnectorConstants.PropertyConfig.USER_ID_CLAIM);
