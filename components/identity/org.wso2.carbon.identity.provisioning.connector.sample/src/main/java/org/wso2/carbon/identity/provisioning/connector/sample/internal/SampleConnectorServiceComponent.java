...
/**
 * @scr.component name=
 *                "org.wso2.carbon.identity.provisioning.connector.sample.internal.SampleConnectorServiceComponent"
 *                immediate="true"
 */
public class SampleConnectorServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            SampleProvisioningConnectorFactory salesforceProvisioningConnectorFactory = new SampleProvisioningConnectorFactory();
