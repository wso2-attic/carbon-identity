...
public class SCIMUserManager implements UserManager {
    ...
    public List<User> listUsersByFilter(String attributeName, String filterOperation,
        ...
        try {
            ...
            throw new CharonException(
                    "Error in getting user information from Carbon User Store for users:" + attributeValue, e);
        }
    ...
    public Group createGroup(Group group) throws CharonException, DuplicateResourceException {
        ...
        if (provisioningConfigManager.isDumbMode()) {
            ...
            try {
                ...
                //this exception can be occurred because of scimGroupHandler.createSCIMAttributes(group) or
                //userContains=false there contextual message could not be provided
    ...
    public Group updateGroup(Group oldGroup, Group newGroup) throws CharonException {
        ...
        if (provisioningConfigManager.isDumbMode()) {
            ...
            try {
                ...
                //contextual message cannot be provided since UserStoreException has been thrown from couple of
                // places
                throw new CharonException(e.getMessage(), e);
            } catch (IdentitySCIMException e) {
                //contextual message cannot be provided since IdentitySCIMException has been thrown from couple of
                // places
                throw new CharonException(e.getMessage(), e);
            }
            return newGroup;
    ...
    public void deleteGroup(String groupId) throws NotFoundException, CharonException {
        ...
        if (provisioningConfigManager.isDumbMode()) {
            ...
            try {
                ...
                throw new CharonException("Error occurred while getting group name for group id :+groupId", e);
            }
        }
    }
    ...
    private User getSCIMUser(String userName) throws CharonException {
        ...
        try {
            ...
            throw new CharonException("Error in getting user information from Carbon User Store for user: " + userName,
                                      e);
