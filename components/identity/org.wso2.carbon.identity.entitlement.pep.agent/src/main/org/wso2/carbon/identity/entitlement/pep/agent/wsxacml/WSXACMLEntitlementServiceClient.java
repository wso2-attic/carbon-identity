...
public class WSXACMLEntitlementServiceClient extends AbstractEntitlementServiceClient {
  ...
  /**
    ...
    @Override
    public boolean subjectCanActOnResource(String subjectType, String alias, String actionId,
                                           String resourceId, Attribute[] attributes,
     ...
     */
    private String extractXACMLResponse(String samlResponse) throws EntitlementAgentException {
        ...
        try {
            ...
            throw new EntitlementAgentException("Error occurred while unmarshalling the SAML Response!", e);
        }
    ...
    private String buildSAMLXACMLAuthzDecisionQuery(String xacmlRequest) throws EntitlementAgentException {
        ...
        try {
            ...
            throw new EntitlementAgentException("Error while building SAMLXACMLAuthzDecisionQuery from the given xacml request.", e);
        }
        ...
        if (xacmlAuthzDecisionQuery != null) {
            try {
                ...
                xacmlAuthzDecisionQueryString = xacmlAuthzDecisionQueryString.replace
     ...
     *
     */
    private XMLObject unmarshall(String xmlString) throws EntitlementAgentException {
        try {
            doBootstrap();
