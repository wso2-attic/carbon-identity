...
<head>
    ...
    <%        String sessionDataKey = request.getParameter("sessionDataKey");
        String url = "https://localhost:9443/oauth2/end_session_endpoint?isLogout=true";%>
</head>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-3 col-centered wr-content wr-login col-centered">
                <div>
                    <h2
                            class="wr-title uppercase blue-bg padding-double white boarder-bottom-blue margin-none">OpenIDConnect Logout
                    </h2>
                </div>
                    ...
                    <form action="../oauth2/authorize" method="post" id="profile" name="oauth2_authz"
                        ...
                        <div class="padding-double login-form">
                            <div class="form-group">
                                <p><strong>Do you want to Logout?
                                </strong></p>
                            </div>
