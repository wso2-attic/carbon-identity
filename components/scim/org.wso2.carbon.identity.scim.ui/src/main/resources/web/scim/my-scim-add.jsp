...
<fmt:bundle
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <form method="post" name="addProviderForm" action="my-scim-add-finish.jsp"
                  target="_self">
                    ...
                    <tr>
                        <td class="buttonRow" >
                            ...
                            <input type="button" class="button"
                                       onclick="javascript:location.href='my-scim-index.jsp?region=region5&item=my_providers_menu'"
