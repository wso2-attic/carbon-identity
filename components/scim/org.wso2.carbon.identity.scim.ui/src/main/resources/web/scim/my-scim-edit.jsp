...
<%
    ...
    try {
            ...
            provider = client.getUserProvider(SCIMUIUtils.getUserConsumerId(userName), providerId);
...
<fmt:bundle basename="org.wso2.carbon.identity.scim.ui.i18n.Resources">
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <form method="post" name="editProviderform" action="my-scim-edit-finish.jsp" target="_self">
                    ...
                    <tr>
                        <td class="buttonRow">
                            ...
                            <input type="button" class="button"
                                   onclick="javascript:location.href='my-scim-index.jsp?region=region5&item=userprofiles_menu&ordinal=0'"
