...
public class AccountCredentialMgtConfigService {
	...
	public void saveEmailConfig(EmailTemplateDTO[] emailTemplates)
		...
		try {
			...
			throw new IdentityMgtServiceException("Error occurred while saving email configuration", e);
		}
	}
	...
	public EmailTemplateDTO[] getEmailConfig() throws IdentityMgtServiceException {
		...
		try {
            ...
            throw new IdentityMgtServiceException("Error occurred while loading email configuration", e);
		}
