...
public class RecoveryProcessor {
    ...
    public NotificationDataDTO recoverWithNotification(UserRecoveryDTO recoveryDTO) throws IdentityException {
        ...
        if ((notificationAddress == null) || (notificationAddress.trim().length() < 0)) {
            throw new IdentityException(
                    "Notification sending failure. Notification address is not defined for user: " + userId);
        }
		...
		try {
            ...
            throw new IdentityException("Error occurred while loading email templates for user : " + userId);
        }
        ...
        if(recoveryDTO.getNotification() != null){
            ...
            if(IdentityMgtConstants.Notification.PASSWORD_RESET_RECOVERY.equals(notification)){
                ...
                try {
                    ...
                    throw new IdentityException("Error occurred while getting external code for user : " + userId);
                }
        ...
        try {
            ...
            throw new IdentityException("Error occurred while creating notification for user : " + userId);
        }
    ...
    public VerificationBean verifyConfirmationCode(int sequence, String username, String code) throws IdentityException{
        ...
        try {
        	...
        	throw new IdentityException("Error loading data for user : " + username, e);
        }
    ...
    public VerificationBean updateConfirmationCode(int sequence, String username, int tenantId) throws IdentityException {
		...
		try {
			...
			throw new IdentityException("Error occurred while getting external code for user : " + username, e);
		}
    ...
    public VerificationBean verifyUserForRecovery(int sequence, UserDTO userDTO) {
        ...
        try {
            ...
            if(userStoreManager.isExistingUser(userId)){
				...
				log.error("User with user name : " + userId + " does not exists in tenant domain : "
            ...
            bean = new VerificationBean(VerificationBean.ERROR_CODE_UN_EXPECTED + " " + errorMessage);
...
//          return new NotificationDataDTO("Email sending is disabled");
      ...
      emailNotificationData.setSendTo(notificationAddress);
		...
		try {
            ...
            throw new IdentityException("Error occurred while loading email templates for user : " + userId, e1);
        }
      ...
      try {
          ...
          throw new IdentityException(
                  "Error occurred while creating notification from email template : " + emailTemplate);
      }
