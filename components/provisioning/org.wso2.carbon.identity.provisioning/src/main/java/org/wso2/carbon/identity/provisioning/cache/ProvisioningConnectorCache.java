...
public class ProvisioningConnectorCache extends BaseCache<CacheKey, CacheEntry> {

    public static final String PROVISIONING_CONNECTOR_CACHE_NAME = "ProvisioningConnectorCache";
    ...
    public static ProvisioningConnectorCache getInstance() {
        if (instance == null) {
            synchronized (ProvisioningConnectorCache.class) {
                ...
                if (instance == null) {
                    instance = new ProvisioningConnectorCache(PROVISIONING_CONNECTOR_CACHE_NAME);
                }
            }
        }
        return instance;
