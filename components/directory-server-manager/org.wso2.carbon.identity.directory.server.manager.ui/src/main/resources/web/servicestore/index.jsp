...
<%@page import="org.wso2.carbon.identity.directory.common.stub.types.ServerPrinciple" %>
<%@page import="org.wso2.carbon.identity.directory.server.manager.ui.DirectoryServerManagerClient" %>
...
<fmt:bundle basename="org.wso2.carbon.identity.directory.server.manager.ui.i18n.Resources">

<carbon:breadcrumb label="service.principles"
		resourceBundle="org.wso2.carbon.identity.directory.server.manager.ui.i18n.Resources"
                    ...
                    %>
                        ...
                        <table class="styledLeft" id="internal" width="100%">
                            ...
                            <tr>
                                ...
                                } catch (org.wso2.carbon.identity.directory.server.manager.ui.ServerManagerClientException e) {
