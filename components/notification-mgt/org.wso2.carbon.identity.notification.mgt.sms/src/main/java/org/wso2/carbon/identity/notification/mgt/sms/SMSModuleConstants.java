...
public class SMSModuleConstants {
    ...
    public static final String SMS_GATEWAY_KEY = "c9360fbe";
    public static final String SMS_GATEWAY_SECRET = "67ae48c8";

    private SMSModuleConstants() {
    }
