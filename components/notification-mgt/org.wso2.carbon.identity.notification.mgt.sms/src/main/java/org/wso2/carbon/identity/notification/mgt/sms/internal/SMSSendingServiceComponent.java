...
package org.wso2.carbon.identity.notification.mgt.sms.internal;
...
import org.wso2.carbon.identity.notification.mgt.sms.SMSMessageModule;

/**
 * @scr.component name="carbon.identity.notification.mgt.sms" immediate="true"
 */

@SuppressWarnings("unused")
public class SMSSendingServiceComponent {

    private static Log log = LogFactory.getLog(SMSSendingServiceComponent.class);
