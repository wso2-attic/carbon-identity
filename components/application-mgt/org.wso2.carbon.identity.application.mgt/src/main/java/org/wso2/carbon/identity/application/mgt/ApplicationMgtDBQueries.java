...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_SEND_LOCAL_SUB_ID_BY_APP_ID = "SELECT IS_SEND_LOCAL_SUBJECT_ID FROM SP_APP WHERE " +
            "TENANT_ID= ? AND ID = ?";
    public static final String LOAD_USE_TENANT_DOMAIN_LOCAL_SUBJECT_ID_BY_APP_ID = "SELECT " +
            "IS_USE_TENANT_DOMAIN_SUBJECT FROM SP_APP WHERE TENANT_ID= ? AND ID = ?";
    public static final String LOAD_USE_USERSTORE_DOMAIN_LOCAL_SUBJECT_ID_BY_APP_ID = "SELECT " +
            "IS_USE_USER_DOMAIN_SUBJECT FROM SP_APP " +
            "WHERE TENANT_ID= ? AND ID = ?";
    ...
    public static final String GET_SP_METADATA_BY_SP_ID = "SELECT ID, NAME, VALUE, DISPLAY_NAME FROM SP_METADATA WHERE SP_ID = ?";
    public static final String ADD_SP_METADATA = "INSERT INTO SP_METADATA (SP_ID, NAME, VALUE, DISPLAY_NAME) VALUES (?, ?, ?, ?)";
