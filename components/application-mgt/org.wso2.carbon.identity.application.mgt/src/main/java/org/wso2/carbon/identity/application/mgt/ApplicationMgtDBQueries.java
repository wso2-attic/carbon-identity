...
public class ApplicationMgtDBQueries {
    ...
    public static final String UPDATE_BASIC_APPINFO_WITH_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID = "UPDATE SP_APP SET " +
            "IS_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID=? WHERE TENANT_ID= ? AND ID = ?";
    public static final String UPDATE_BASIC_APPINFO_WITH_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID = "UPDATE SP_APP SET " +
