...
public class ApplicationMgtDBQueries {
    ...
    public static final String UPDATE_BASIC_APPINFO_WITH_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID = "UPDATE SP_APP SET IS_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID=? WHERE TENANT_ID= ? AND ID = ?";
    public static final String UPDATE_BASIC_APPINFO_WITH_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID = "UPDATE SP_APP SET IS_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID=? WHERE TENANT_ID= ? AND ID = ?";
    public static final String UPDATE_BASIC_APPINFO_WITH_SEND_AUTH_LIST_OF_IDPS = "UPDATE SP_APP SET IS_SEND_AUTH_LIST_OF_IDPS=? WHERE TENANT_ID= ? AND ID = ?";
    ...
    public static final String UPDATE_BASIC_APPINFO_WITH_AUTH_TYPE = "UPDATE SP_APP SET AUTH_TYPE=? WHERE TENANT_ID= ? "+
            "AND ID = ?";
    public static final String UPDATE_BASIC_APPINFO_WITH_PRO_USERSTORE = "UPDATE SP_APP SET PROVISIONING_USERSTORE_" +
            "DOMAIN=? WHERE TENANT_ID= ? AND ID = ?";
    ...
    public static final String LOAD_BASIC_APP_INFO_BY_APP_NAME = "SELECT * FROM SP_APP WHERE APP_NAME = ? AND TENANT_ID"
            + "= ?";
    ...
    public static final String LOAD_ROLE_MAPPING_BY_APP_ID = "SELECT IDP_ROLE, SP_ROLE FROM SP_ROLE_MAPPING WHERE APP_ID"+
            " = ? AND TENANT_ID = ?";
    public static final String LOAD_ROLE_CLAIM_BY_APP_ID = "SELECT ROLE_CLAIM FROM SP_APP WHERE TENANT_ID= ? AND ID = ?";
    public static final String LOAD_CLAIM_DIALECT_BY_APP_ID = "SELECT IS_LOCAL_CLAIM_DIALECT FROM SP_APP WHERE TENANT_ID="
            + " ? AND ID = ?";
    public static final String LOAD_SEND_LOCAL_SUB_ID_BY_APP_ID = "SELECT IS_SEND_LOCAL_SUBJECT_ID FROM SP_APP WHERE " +
            "TENANT_ID= ? AND ID = ?";
    public static final String LOAD_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID_BY_APP_ID = "SELECT IS_USE_TENANT_DIMAIN_LOCAL_SUBJECT_ID FROM SP_APP " +
            "WHERE TENANT_ID= ? AND ID = ?";
    public static final String LOAD_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID_BY_APP_ID = "SELECT " +
            "IS_USE_USERSTORE_DIMAIN_LOCAL_SUBJECT_ID FROM SP_APP " +
            "WHERE TENANT_ID= ? AND ID = ?";
    public static final String LOAD_SEND_AUTH_LIST_OF_IDPS_BY_APP_ID = "SELECT IS_SEND_AUTH_LIST_OF_IDPS FROM SP_APP " +
            "WHERE TENANT_ID= ? AND ID = ?";
    public static final String LOAD_SUBJECT_CLAIM_URI_BY_APP_ID = "SELECT SUBJECT_CLAIM_URI FROM SP_APP WHERE " +
            "TENANT_ID= ? AND ID = ?";
    ...
    public static final String LOAD_PRO_USERSTORE_BY_APP_ID = "SELECT PROVISIONING_USERSTORE_DOMAIN FROM " +
    ...
    public static final String LOAD_IDP_AUTHENTICATOR_ID = "SELECT A.ID FROM IDP_AUTHENTICATOR A JOIN IDP B ON A.IDP_ID"
            +
            "= B" +
            ".ID WHERE A.NAME =? AND B.NAME=? AND ((A.TENANT_ID =? AND B.TENANT_ID =?) OR (B.TENANT_ID=? AND B" +
            ".NAME LIKE 'SHARED_%'))";
