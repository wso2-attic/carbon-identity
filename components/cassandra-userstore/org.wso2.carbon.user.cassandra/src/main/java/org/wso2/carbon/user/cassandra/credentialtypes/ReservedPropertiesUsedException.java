...
public class ReservedPropertiesUsedException extends MultipleCredentialsException{
    ...
    public ReservedPropertiesUsedException(String message, Throwable cause) {
        super(message, cause);
    }

    public ReservedPropertiesUsedException(String message, boolean convertMessage) {
        super(message, convertMessage);
    }

    public ReservedPropertiesUsedException(String message) {
        super(message);
    }

    public ReservedPropertiesUsedException(Throwable cause) {
        super(cause);
    }
}
