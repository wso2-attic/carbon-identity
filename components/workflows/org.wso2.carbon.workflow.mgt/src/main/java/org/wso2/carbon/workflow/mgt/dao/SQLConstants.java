...
public class SQLConstants {
    ...
    public static final String GET_WS_SERVICES_FOR_EVENT_QUERY = "SELECT WF_WS_SERVICES.ALIAS, " +
            ...
            "WF_WS_SERVICES.PASSWORD, WF_EVENT_SERVICE_MAP.CONDITION FROM WF_WS_SERVICES, " +
            "WF_EVENT_SERVICE_MAP WHERE WF_EVENT_SERVICE_MAP.SERVICE_ALIAS = WF_WS_SERVICES.ALIAS AND " +
            "WF_EVENT_SERVICE_MAP.EVENT = ?";
