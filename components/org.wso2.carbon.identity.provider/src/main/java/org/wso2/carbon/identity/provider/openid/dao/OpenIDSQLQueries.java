...
public class OpenIDSQLQueries {
	...
	public static final String STORE_ASSOCIATION = "INSERT INTO " + "IDN_OPENID_ASSOCIATIONS " +
			"(HANDLE, ASSOC_TYPE, EXPIRE_IN, MAC_KEY, ASSOC_STORE) " + "VALUES (?,?,?,?,?)";
    ...
    public static final String UPDATE_REMEMBER_ME_TOKEN = "UPDATE " + "IDN_OPENID_REMEMBER_ME " +
    		"SET COOKIE_VALUE = ?" + " WHERE USER_NAME = ? AND TENANT_ID = ?";
    
    public static final String LOAD_REMEMBER_ME_TOKEN = "SELECT " + "USER_NAME, TENANT_ID, COOKIE_VALUE, CREATED_TIME " +
    ...
    public static final String LOAD_USER_RP = "SELECT " + "USER_NAME, TENANT_ID, RP_URL, TRUSTED_ALWAYS, LAST_VISIT, VISIT_COUNT, DEFAULT_PROFILE_NAME " +
    		"FROM IDN_OPENID_USER_RPS " + "WHERE USER_NAME = ? AND TENANT_ID = ? AND RP_URL = ?";
    
    public static final String LOAD_ALL_USER_RPS = "SELECT " + "USER_NAME, TENANT_ID, RP_URL, TRUSTED_ALWAYS, LAST_VISIT, VISIT_COUNT, DEFAULT_PROFILE_NAME " +
    		"FROM IDN_OPENID_USER_RPS ";
    
    public static final String LOAD_USER_RPS = "SELECT " + "USER_NAME, TENANT_ID, RP_URL, TRUSTED_ALWAYS, LAST_VISIT, VISIT_COUNT, DEFAULT_PROFILE_NAME " +
