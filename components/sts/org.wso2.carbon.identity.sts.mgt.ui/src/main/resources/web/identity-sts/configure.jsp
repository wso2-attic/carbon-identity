        ...
        <div id="workArea">
            ...
            <form action="update_config.jsp" id="configuration" name="configuration">
                <table class="styledLeft" width="100%">
                    <tr>
                        <td colspan="2"
                            style="border-left: 0px !important; border-right: 0px !important; border-top: 0px !important; padding-left: 0px !important; height: 5px !important;"></td>
                    </tr>
                    <tr>
                            ...
                            <table class="normal" cellspacing="0">
                                <tr>
                                    ...
                                    <td><input type="text" name="cardName" id="cardName"
                                               value="<%=cardIssuer.getCardName()%>"/></td>
                                </tr>
                                <tr>
                                    <td><fmt:message key='valid.period'/><font class="required">*</font></td>
                                    <td><input type="text" name="validPeriod" id="validPeriod"
                                               value="<%=cardIssuer.getValidPeriodInDays()%>"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="margin-left: 0">
                                        ...
                                        <div>
                                            <input type="hidden"
                                                   name='<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType() + "hidden"%>'
                                                   id='<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType() + "hidden"%>'
                                                   value="true"/>
                                            <input type='checkbox'
                                                   name='<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType()%>'
                                                   id='<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType()%>'
                                                   checked='checked'
                                                   onclick="setValue('<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType()%>','<%=cardIssuer.getSupportedTokenTypes()[i].getTokenType()+"hidden"%>')"/> <%=cardIssuer
                                                .getSupportedTokenTypes()[i].getTokenType()%> &nbsp;
                                        </div>
                                        <% } else { %>
                                        <div>
                                            <input type="hidden"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name='symmetricBinding' id='symmetricBinding'
                                               value="true"/>
                                        <input type='checkbox' name='isSymmetricBinding' value='isSymmetricBinding'
                                               id='isSymmetricBinding' checked='checked'
                                               onclick="setValue('isSymmetricBinding','symmetricBinding')"/>
                                    </td>
                                    <% } else { %>
                                    <td>
                                        <input type="hidden" name='symmetricBinding' id='symmetricBinding'
                    ...
                    <tr>
                        <td colspan="2" class="buttonRow">
                            <input class="button" type="button" value="<fmt:message key='update'/>"
                                   onclick="javascript: validate(document.configuration)"/>
                            <input class="button" type="reset" value="<fmt:message key='cancel'/>"
                                   onclick="javascript:document.location.href='index.jsp?region=region1&item=sts_menu&ordinal=0'"/
                            >
                        </td>
                    </tr>
                </table>
