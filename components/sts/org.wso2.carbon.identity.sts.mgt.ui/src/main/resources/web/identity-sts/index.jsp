    ...
    <div id="middle">
        ...
        <div id="workArea">
            <table cellspacing="0" class="normal">
                <tr>
                    <td>
                        <a href="../identity-sts/configure.jsp" class="icon-link"
            ...
            <table class="styledLeft" width="100%">
                <tr>
                    <td colspan="2"
                        style="border-left: 0px !important; border-right: 0px !important; border-top: 0px !important; padding-left: 0px !important; height: 5px !important;">
                        <img src="../identity-sts/images/1px.gif" height="5"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><%=cardIssuer.getCardName()%>
                    </td>
                </tr>
                <tr>
                    <td><fmt:message key='valid.period'/></td>
                    <td><%=cardIssuer.getValidPeriodInDays()%>
                    </td>
                </tr>
                <tr>
                    <td><fmt:message key='supporting.token.types'/></td>
                    <td><%=client.getSupportingTokens(cardIssuer.getSupportedTokenTypes())%>
                    </td>
                </tr>
                <tr>
