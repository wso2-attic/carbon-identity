...
<div id="workArea">
			...
			<table class="styledLeft" width="100%" id="trustedServices">
					...
					<tbody>
						...
						if (services != null && services.length>0) {
         				...
         				%>
							  <tr>
								<td width="40%"><%=service.getServiceAddress()%></td>
								<td width="40%">&nbsp;&nbsp;<%=service.getCertAlias()%></td>
								<td width="20%">
    ...
    <form method="get" action="index.jsp" name="trustedservice" onsubmit="return doValidation();">
				...
				<tr>
                    		...
                    		<td><input type="text" id="endpointaddrs" name="endpointaddrs" class="text-box-big"/></td>
                		</tr>
                       <tr>
