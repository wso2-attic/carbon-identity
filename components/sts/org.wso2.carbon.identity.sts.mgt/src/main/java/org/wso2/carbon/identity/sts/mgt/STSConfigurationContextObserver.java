...
public class STSConfigurationContextObserver extends AbstractAxis2ConfigurationContextObserver {
    ...
    private final static Log log = LogFactory.getLog(STSConfigurationContextObserver.class);
    ...
    public void createdConfigurationContext(ConfigurationContext configurationContext) {
        ...
        try {
            ...
            String msg = "Failed to configure STS service for tenant: " + tenantDomain + "[" + tenantID + "]" + " - " + e.getMessage();
            log.error(msg, e);
        }
    }
}
