...
public class AccessTokenIssuer {
    ...
    private void setResponseHeaders(OAuthTokenReqMessageContext tokReqMsgCtx, OAuth2AccessTokenRespDTO tokenRespDTO) {
        if (tokReqMsgCtx.getProperty("RESPONSE_HEADERS_PROPERTY") != null) {
            tokenRespDTO.setResponseHeaders((ResponseHeader[]) tokReqMsgCtx.getProperty("RESPONSE_HEADERS_PROPERTY"));
        }
    }
}
