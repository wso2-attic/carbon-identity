...
<%@page import="org.wso2.carbon.identity.security.ui.jsp.SecurityUIUtil" %>
...
<jsp:useBean id="ksBean" type="org.wso2.carbon.identity.security.ui.client.KeyStoreBean" class="org.wso2.carbon.identity.security.ui.client.KeyStoreBean" scope="session"/>
 ...
 <%
        ...
        try {
            ...
            if (ServletFileUpload.isMultipartContent(request)) {
                ...
                session.setAttribute("org.wso2.carbon.identity.security.content", content);
                session.setAttribute("org.wso2.carbon.identity.security.fileName", fileName);
                session.setAttribute("org.wso2.carbon.identity.security.ksPassword", ksPassword);
                session.setAttribute("org.wso2.carbon.identity.security.provider", provider);
                session.setAttribute("org.wso2.carbon.identity.security.keystoreType", keystoreType);
...
<fmt:bundle basename="org.wso2.carbon.identity.security.ui.i18n.Resources">
