...
package org.wso2.carbon.identity.security.config;
...
import org.wso2.carbon.identity.security.config.service.KerberosConfigData;
import org.wso2.carbon.identity.security.config.service.SecurityConfigData;
import org.wso2.carbon.identity.security.config.service.SecurityScenarioData;
import org.wso2.carbon.identity.security.pox.POXSecurityHandler;
import org.wso2.carbon.identity.security.util.SecurityTokenStore;
import org.wso2.carbon.identity.security.util.ServerCrypto;
import org.wso2.carbon.identity.security.util.ServicePasswordCallbackHandler;
...
public class SecurityConfigAdmin {
    ...
    private void addUserParameters(OMElement policyElement, String[] trustedStores, String privateStore,
        ...
        if (userGroups != null && userGroups.length > 0) {
            ...
            OMAttribute propertyNameAttribute = factory.createOMAttribute(SecurityConstants.NAME_LABEL, null,
                    "org.wso2.carbon.identity.security.allowedroles");
     ...
     * @throws org.wso2.carbon.identity.security.SecurityConfigException ex
     */
