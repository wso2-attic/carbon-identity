...
package org.wso2.carbon.identity.security.config.service;
...
public class SecurityConfigAdminService extends AbstractAdmin {
     ...
     * @throws org.wso2.carbon.identity.security.SecurityConfigException If unable to add kerberos attributes.
     */
