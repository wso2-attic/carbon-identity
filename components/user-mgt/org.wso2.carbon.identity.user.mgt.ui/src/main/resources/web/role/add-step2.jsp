...
<%@page import="org.wso2.carbon.identity.user.mgt.stub.types.carbon.UIPermissionNode"%>
...
<jsp:useBean id="roleBean" type="org.wso2.carbon.identity.user.mgt.ui.RoleBean"
                    class="org.wso2.carbon.identity.user.mgt.ui.RoleBean" scope="session"/>
