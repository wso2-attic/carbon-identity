...
<%@ page import="org.wso2.carbon.identity.user.mgt.stub.types.carbon.ClaimValue" %>
...
<%@ page import="org.wso2.carbon.identity.user.mgt.ui.PaginatedNamesBean" %>
...
<%@ page import="org.wso2.carbon.identity.user.mgt.ui.UserManagementWorkflowServiceClient" %>
