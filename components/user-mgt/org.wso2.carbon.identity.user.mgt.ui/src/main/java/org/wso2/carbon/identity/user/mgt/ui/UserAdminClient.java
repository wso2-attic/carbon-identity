...
package org.wso2.carbon.identity.user.mgt.ui;
...
import org.wso2.carbon.identity.user.mgt.stub.types.carbon.UIPermissionNode;
...
public class UserAdminClient  {
    ...
    public FlaggedName[] listUserByClaim(ClaimValue claimValue, String filter, int limit) throws AxisFault {
        try {
            org.wso2.carbon.identity.user.mgt.stub.types.carbon.ClaimValue abcdClaimValue = new
                   org.wso2.carbon.identity.user.mgt.stub.types.carbon.ClaimValue();
