...
import org.wso2.carbon.identity.um.ws.api.internal.UserMgtWSAPIDSComponent;
import org.wso2.carbon.identity.um.ws.api.stub.RemoteTenantManagerServiceStub;
...
public class WSRealmTenantManager implements TenantManager {
    ...
    public Tenant[] getAllTenants() throws UserStoreException {
        try {
            org.wso2.carbon.identity.um.ws.api.stub.Tenant[] tenats = stub.getAllTenants();
            if (tenats != null) {
    ...
    private Tenant ADBTenantToTenant(org.wso2.carbon.identity.um.ws.api.stub.Tenant stubTenant) {
    ...
    private org.wso2.carbon.identity.um.ws.api.stub.Tenant tenantToADBTenant(Tenant tenant) {
        org.wso2.carbon.identity.um.ws.api.stub.Tenant stubTenant = new org.wso2.carbon.identity.um.ws.api.stub.Tenant();
