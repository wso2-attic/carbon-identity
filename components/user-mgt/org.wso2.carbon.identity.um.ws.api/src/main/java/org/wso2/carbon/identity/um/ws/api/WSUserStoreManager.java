...
import org.wso2.carbon.identity.um.ws.api.stub.PermissionDTO;
import org.wso2.carbon.identity.um.ws.api.stub.RemoteUserStoreManagerServiceStub;
...
public class WSUserStoreManager implements UserStoreManager {
    ...
    private PermissionDTO[] convertPermission(Permission[] permissions) {
        ...
        for (int i = 0; i < permissions.length; i++) {
            perms[i] = new org.wso2.carbon.identity.um.ws.api.stub.PermissionDTO();
