...
package org.wso2.carbon.identity.um.ws.api;

import org.wso2.carbon.identity.um.ws.api.stub.Claim;
import org.wso2.carbon.identity.um.ws.api.stub.ClaimDTO;
import org.wso2.carbon.identity.um.ws.api.stub.ClaimValue;
import org.wso2.carbon.identity.um.ws.api.stub.ProfileConfiguration;
import org.wso2.carbon.identity.um.ws.api.stub.RealmConfigurationDTO;
import org.wso2.carbon.identity.um.ws.api.stub.RealmPropertyDTO;
...
public class WSRealmUtil {
    ...
    public static org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping[] convertToADBClaimMappings(
            org.wso2.carbon.user.core.claim.ClaimMapping[] claimMappings) {
        if (claimMappings == null) {
            return new org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping[0];
        }
        org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping[] cms = new org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping[claimMappings.length];
        int i = 0;
        for (org.wso2.carbon.user.core.claim.ClaimMapping claimMapping : claimMappings) {
            org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping cm = new org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping();
    ...
    public static org.wso2.carbon.identity.um.ws.api.stub.Claim convertToADBClaim(org.wso2.carbon.user.api.Claim claim) {
        if (claim == null) {
            return null;
        }
        org.wso2.carbon.identity.um.ws.api.stub.Claim claimz = new org.wso2.carbon.identity.um.ws.api.stub.Claim();
    ...
    public static org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping convertToADBClaimMapping(
    ...
    public static org.wso2.carbon.identity.um.ws.api.stub.Claim[] convertToADBClaims(org.wso2.carbon.user.core.claim.Claim[] claims) {
        if (claims == null) {
            return new Claim[0];
        }

        org.wso2.carbon.identity.um.ws.api.stub.Claim[] claimz = new org.wso2.carbon.identity.um.ws.api.stub.Claim[claims.length];
    ...
    public static ClaimMapping[] convertToClaimMappings(org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping[] claimMappings) {
        if (claimMappings == null) {
            return new ClaimMapping[0];
        }
        ClaimMapping[] claimz = new ClaimMapping[claimMappings.length];
        int i = 0;
        for (org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping claim : claimMappings) {
    ...
    private static org.wso2.carbon.user.core.claim.Claim convertToClaim(ClaimDTO claimDTO, org.wso2.carbon.identity.um.ws.api
            .stub
            .Claim claim) {
    ...
    public static org.wso2.carbon.user.core.claim.Claim convertToClaim(org.wso2.carbon.identity.um.ws.api.stub.Claim claim) {
        if (claim == null) {
            return null;
        }
    ...
    public static org.wso2.carbon.user.core.claim.ClaimMapping convertToClaimMapping(
            org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping claimMapping) {
        if (claimMapping == null) {
            return null;
        }
