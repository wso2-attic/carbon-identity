...
import org.wso2.carbon.identity.um.ws.api.stub.RemoteClaimManagerServiceStub;
import org.wso2.carbon.identity.um.ws.api.stub.RemoteClaimManagerServiceUserStoreExceptionException;
...
public class WSClaimManager implements ClaimManager {
    ...
    public void addNewClaimMapping(ClaimMapping mapping) throws UserStoreException {
        try {
            org.wso2.carbon.identity.um.ws.api.stub.ClaimMapping claimMapping = WSRealmUtil
