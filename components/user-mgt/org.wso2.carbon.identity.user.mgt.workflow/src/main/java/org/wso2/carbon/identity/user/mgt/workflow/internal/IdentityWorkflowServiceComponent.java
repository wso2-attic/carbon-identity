...
package org.wso2.carbon.identity.user.mgt.workflow.internal;
...
import org.wso2.carbon.identity.user.mgt.workflow.userstore.AddRoleWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.AddUserWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.DeleteClaimWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.DeleteMultipleClaimsWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.DeleteRoleWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.DeleteUserWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.SetMultipleClaimsWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.SetUserClaimWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.UpdateRoleNameWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.UpdateRoleUsersWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.UpdateUserRolesWFRequestHandler;
import org.wso2.carbon.identity.user.mgt.workflow.userstore.UserStoreActionListener;
