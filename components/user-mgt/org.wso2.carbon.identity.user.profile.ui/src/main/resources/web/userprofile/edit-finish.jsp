...
<%
    ...
    try {
        ...
        String message = MessageFormat.format(resourceBundle.getString(
                "error.while.updating.user.profile"), decodedUsername, e.getMessage());
        CarbonUIMessage.sendCarbonUIMessage(message, CarbonUIMessage.ERROR, request);
        forwardTo = "edit.jsp?username=" + encodedUsername + "&profile=" + profile + "&fromUserMgt=true&noOfProfiles=" + noOfProfiles;
    }
%>
