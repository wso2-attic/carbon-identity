...
public class UserAccountAssociationConstants {
    ...
    public enum ErrorMessages {
        ...
        CONN_UPDATE_DB_ERROR(8504, "Database error occurred while updating user account association"),
        CHECK_ASSOCIATION_DB_ERROR(8504, "Database error occurred while validating user association"),
        ASSOCIATIONS_DELETE_DB_ERROR(8503, "Database error occurred while deleting user account associations"),
        ERROR_WHILE_LOADING_REALM_SERVICE(8504, "Error occurred while getting the RealmService"),
        ERROR_WHILE_ACCESSING_REALM_SERVICE(8504, "Error occurred while accessing the RealmService"),
        ERROR_WHILE_RETRIEVING_ASSOC_KEY(8504, "Error occurred while getting the RealmService"),
        ERROR_WHILE_GETTING_TENANT_NAME(8504, "Error occurred while getting tenant name from tenant id"),
        ERROR_WHILE_GETTING_TENANT_ID(8504, "Error occurred while getting tenant id from tenant name"),
        ERROR_WHILE_AUTHENTICATING_USER(8504, "Error occurred while authenticating user"),
        ERROR_WHILE_DELETING_USER_ASSOC(8504, "Error occurred while deleting user account association for user %s"),
        ERROR_WHILE_RETRIEVING_REMOTE_ADDRESS(8504, "Error occurred while retrieving remote address"),
        ERROR_WHILE_UPDATING_SESSION(8504, "Error occurred while updating session parameters"),
        ERROR_WHILE_EXECUTING_AUTHENTICATORS(8504, "Error occurred while executing pre/post user authenticators"),
        ...
        DEBUG_INVALID_TENANT_DOMAIN(8510, "Invalid or inactivated tenant domain '%s'"),
        INVALID_TENANT_DOMAIN(8510, "Invalid or inactivated tenant domain"),
        ...
        SAME_ACCOUNT_CONNECTING_ERROR(85018, "User can not associate logged in user account to itself");
